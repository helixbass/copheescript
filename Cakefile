...
task 'test:prettier', 'run the CoffeeScript language test suite', ->
  runTests(CoffeeScript, justTestFile: [
    ...
    'cluster', 'comments', 'comprehensions', 'control_flow', 'csx'
    'error_messages', 'eval', 'exception_handling', 'exponentiation'
    'formatting', 'function_invocation', 'functions', 'generators', 'helpers'
    'importing', 'interpolation', 'javascript_literals', 'literate'
    'literate_tabbed', 'location', 'modules', 'numbers', 'object_rest_spread'
    'objects', 'operators', 'option_parser', 'parser', 'ranges', 'regex'
