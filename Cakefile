...
task 'test:prettier', 'run the CoffeeScript language test suite', ->
  runTests(CoffeeScript, justTestFile: [
    ...
    'cluster', 'comments', 'compilation', 'comprehensions', 'control_flow'
    'csx', 'error_messages', 'eval', 'exception_handling', 'exponentiation'
    'formatting', 'function_invocation', 'functions', 'generators', 'helpers'
    'importing', 'interpolation', 'invocation_argument_parsing'
...
task 'test:printer', 'run the CoffeeScript language test suite', ->
  runTests(CoffeeScript, justTestFile: [
    ...
    'control_flow', 'eval', 'exception_handling', 'exponentiation', 'formatting'
    'function_invocation', 'functions', 'generators', 'helpers', 'importing'
    'interpolation', 'invocation_argument_parsing', 'javascript_literals'
    'literate', 'literate_tabbed', 'location'
    #'modules'
