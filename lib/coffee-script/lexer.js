...
(function() {
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.regexToken = function() {
      ...
      switch (false) {
        ...
        default:
          ...
          this.token('STR_CONCAT', 'STR_CONCAT');
          this.mergeInterpolationTokens(tokens, {
            delimiter: "'"
          }, this.formatHeregex);
          this.token('STR_CONCAT', 'STR_CONCAT');
    ...
    Lexer.prototype.mergeInterpolationTokens = function(tokens, options, fn) {
      ...
      for (i = j = 0, len = tokens.length; j < len; i = ++j) {
        ...
        if (this.tokens.length > firstIndex) {
          plusToken = this.token('STR_CONCAT', 'STR_CONCAT');
          plusToken[2] = {
    ...
    Lexer.prototype.makeDelimitedLiteral = function(body, options) {
      ...
      regex = RegExp("(\\\\\\\\)|\\\\?(" + options.delimiter + ")|\\\\?(?:(\\n)|(\\r)|(\\u2028)|(\\u2029))|(\\\\.)", "g");
      body = body.replace(regex, function(match, backslash, delimiter, lf, cr, ls, ps, other) {
        switch (false) {
          case !backslash:
            if (options.double) {
  ...
  JS_KEYWORDS = ['true', 'false', 'null', 'this', 'new', 'delete', 'typeof', 'in', 'instanceof', 'return', 'throw', 'break', 'continue', 'debugger', 'yield', 'if', 'else', 'switch', 'for', 'while', 'do', 'try', 'catch', 'finally', 'class', 'extends', 'super', 'trait', 'abstract'];
  ...
  RESERVED = ['case', 'default', 'function', 'var', 'void', 'with', 'const', 'let', 'enum', 'export', 'import', 'native', 'implements', 'interface', 'package', 'private', 'protected', 'public'];
