...
(function() {
  ...
  exports.Class = Class = (function(superClass) {
    ...
    Class.prototype.compileNode = function(o) {
      var args, argumentsNode, func, jumpNode, lname, name, ref3;
  ...
  exports.Code = Code = (function(superClass) {
    ...
    Code.prototype.compileNode = function(o) {
      var answer, boundfunc, code, exprs, i, j, k, l, len1, len2, len3, len4, len5, len6, len7, lit, m, p, param, params, q, r, ref, ref10, ref11, ref3, ref4, ref5, ref6, ref7, ref8, ref9, s, splats, uniqs, use, uses, val, wasEmpty, wrapper;
      ...
      for (m = 0, len4 = ref7.length; m < len4; m++) {
        ...
        if (0 === param.name.value.indexOf('USE')) {
          param.uses = true;
          uses.unshift.apply(uses, param.name.value.substr(3).split('_$').slice(1));
        }
      }
      ref8 = this.params;
