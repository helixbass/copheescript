...
(function() {
  ...
  exports.Value = Value = (function(superClass) {
    ...
    Value.prototype.isVar = function() {
      return !this.isSimpleNumber() && IS_VAR.test(this.base.value);
    };
    ...
    Value.prototype.compileNode = function(o) {
      ...
      if (this.base.value && this.isVar() && ((ref3 = this.properties) != null ? (ref4 = ref3[0]) != null ? (ref5 = ref4.name) != null ? ref5.value : void 0 : void 0 : void 0) !== 'prototype') {
  ...
  exports.Class = Class = (function(superClass) {
    ...
    Class.prototype.compileNode = function(o) {
      var args, argumentsNode, expression, func, j, jumpNode, len1, lname, name, ref3, ref4;
      ...
      console.log('class body.expressions', this.body.expressions);
  ...
  exports.Code = Code = (function(superClass) {
    ...
    Code.prototype.compileNode = function(o) {
      var answer, boundfunc, code, compiled_body, exprs, i, j, k, l, len1, len2, len3, len4, len5, len6, len7, lit, m, p, param, params, q, r, ref, ref10, ref11, ref3, ref4, ref5, ref6, ref7, ref8, ref9, s, splats, uniqs, use, uses, val, wasEmpty, wrapper;
      ...
      if ((ref10 = this.name) != null ? (ref11 = ref10.name) != null ? ref11.value : void 0 : void 0) {
      ...
      if (uses.length) {
        ...
        answer.push(this.makeCode([
          (function() {
            var len8, results, t;
            results = [];
            for (t = 0, len8 = uses.length; t < len8; t++) {
              use = uses[t];
              results.push("" + use);
            }
            return results;
