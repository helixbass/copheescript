...
(function() {
  ...
  exports.Code = Code = (function(superClass) {
    ...
    Code.prototype.compileNode = function(o) {
      var _param, _var, answer, boundfunc, code, compiled_body, exp, exprs, i, j, k, l, len1, len2, len3, len4, len5, len6, len7, len8, lit, m, p, param, params, q, r, ref, ref10, ref11, ref12, ref3, ref4, ref5, ref6, ref7, ref8, ref9, s, splats, t, uniqs, use, uses, val, wasEmpty, wrapper;
      ...
      for (i = r = 0, len6 = ref10.length; r < len6; i = ++r) {
        exp = ref10[i];
        if (!(exp instanceof If && (_var = exp.condition.value.match(/^(\$\w+) == null$/)[1]) && (_param = this.hasParamNamed(_var)))) {
          break;
        }
      ...
      if ((ref11 = this.name) != null ? (ref12 = ref11.name) != null ? ref12.value : void 0 : void 0) {
  ...
  exports.Param = Param = (function(superClass) {
    ...
    Param.prototype.compileToFragments = function(o) {
      if (0 === this.name.value.indexOf('WRAP')) {
        this.name.value = this.name.value.substr(5);
        return [this.name.makeCode('Wrap ')].concat(slice.call(this.name.compileToFragments(o, LEVEL_LIST)));
      } else {
        return this.name.compileToFragments(o, LEVEL_LIST).concat(this._default ? [this.name.makeCode("=" + this._default)] : []);
      }
    };
