...
(function() {
  ...
  var FILE_EXTENSIONS, Lexer, SourceMap, babelTraverse, babylonToEspree, babylonTokenTypes, base64encode, checkShebangLine, compile, compileToBabylon, dump, espreeTokenTypes, extraTokensForESLint, flatten, formatSourcePosition, getEspreeTokenType, getSourceMap, helpers, isPlainObject, lexer, locationFields, merge, packageJson, parser, prettier, sourceMaps, sources, tokensForESLint, traverseBabylonAst, traverseBabylonAsts, withPrettyErrors,
  ...
  exports.compile = compile = withPrettyErrors(function(code, options = {}) {
    ...
    js = (() => {
      ...
      if (options.usePrettier) {
        ({formatted, ast} = parsed.prettier(merge(options, {
          code,
          returnWithAst: true
        })));
        if (!generateSourceMap) {
  ...
  traverseBabylonAsts = function(node, correspondingNode, func) {
