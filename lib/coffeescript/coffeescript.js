...
(function() {
  ...
  var FILE_EXTENSIONS, Lexer, SourceMap, babelTraverse, babylonTokenTypes, base64encode, checkShebangLine, compile, compileToBabylon, dump, espreeTokenTypes, extraTokensForESLint, flatten, formatSourcePosition, getEspreeTokenType, getSourceMap, helpers, isPlainObject, lexer, merge, packageJson, parser, prettier, printer, registerCompiled, sourceMaps, sources, tokensForESLint, traverseBabylonAst, traverseBabylonAsts, withPrettyErrors,
    indexOf = [].indexOf;
  ...
  exports.compile = compile = withPrettyErrors(function(code, options = {}) {
    var ast, comments, encoded, filename, generateSourceMap, i, js, len, map, nodes, range, ref, ref1, sourceCodeLastLine, sourceCodeNumberOfLines, sourceMapDataURI, sourceURL, token, tokens, transpiler, transpilerOptions, transpilerOutput, v3SourceMap;
    ...
    js = (() => {
      var currentColumn, currentLine, formatted, fragment, fragments, header, j, len1, newLines, prettierAst;
  ...
  exports.nodes = withPrettyErrors(function(source, options) {
    if (typeof source === 'string') {
      source = lexer.tokenize(source, options).tokens;
    }
