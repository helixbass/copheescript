...
(function() {
  ...
  var FILE_EXTENSIONS, Lexer, SourceMap, babelTraverse, babylonTokenTypes, base64encode, checkShebangLine, compile, compileToBabylon, dump, espreeTokenTypes, extraTokensForESLint, flatten, formatSourcePosition, getEspreeTokenType, getSourceMap, helpers, isPlainObject, lexer, merge, packageJson, parser, prettier, sourceMaps, sources, tokensForESLint, traverseBabylonAst, traverseBabylonAsts, withPrettyErrors,
    indexOf = [].indexOf;
