...
(function() {
  ...
  var FILE_EXTENSIONS, Lexer, SourceMap, babelTraverse, babylonToEspree, babylonTokenTypes, base64encode, checkShebangLine, compile, compileToBabylon, dump, espreeTokenTypes, extraTokensForESLint, flatten, formatSourcePosition, getEspreeTokenType, getSourceMap, helpers, isPlainObject, lexer, merge, packageJson, parser, sourceMaps, sources, tokensForESLint, traverseBabylonAst, withPrettyErrors,
  ...
  exports.compile = compile = withPrettyErrors(function(code, options = {}) {
    ...
    js = (() => {
      ...
      if (options.usePrettier) {
        return parsed.prettier(merge(options, {code}));
      }
