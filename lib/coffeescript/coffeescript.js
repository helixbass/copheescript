...
(function() {
  ...
  var FILE_EXTENSIONS, Lexer, SourceMap, babelTraverse, babylonToEspree, babylonTokenTypes, base64encode, checkShebangLine, compile, compileToBabylon, dump, formatSourcePosition, getSourceMap, helpers, lexer, packageJson, parser, sourceMaps, sources, withPrettyErrors,
  ...
  exports.parseForESLint = function(code, opts) {
    var ast, locationData, tokens, type, value;
    opts.bare = true;
    ...
    ast.tokens = (function() {
      ...
      results = [];
      for (i = 0, len = tokens.length; i < len; i++) {
        [type, value, locationData] = tokens[i];
        results.push(_extends({type, value}, helpers.locationDataToBabylon(locationData)));
      }
      return results;
    })();
