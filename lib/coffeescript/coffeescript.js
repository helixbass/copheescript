...
(function() {
  ...
  exports.compile = compile = withPrettyErrors(function(code, options = {}) {
    var comments, encoded, filename, generateSourceMap, i, js, len, map, parsed, ref, ref1, sourceMapDataURI, sourceURL, token, tokens, transpiler, transpilerOptions, transpilerOutput, v3SourceMap;
    ...
    js = (() => {
      ...
      if (options.usePrettier) {
        ...
        fragments = options.usePrinter ? printer.print(parsed.compileToBabylon(options), options) : parsed.compileToFragments(options);
        currentLine = 0;
        if (options.header) {
          currentLine += 1;
        }
  ...
  exports.babylon = compileToBabylon = withPrettyErrors(function(source, options) {
    var ast, comments, parsed, tokens;
