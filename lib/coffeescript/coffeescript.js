...
(function() {
  ...
  exports.compile = compile = withPrettyErrors(function(code, options = {}) {
    var ast, comments, encoded, filename, generateSourceMap, i, js, len, map, nodes, ref, ref1, sourceCodeLastLine, sourceCodeNumberOfLines, sourceMapDataURI, sourceURL, token, tokens, transpiler, transpilerOptions, transpilerOutput, v3SourceMap;
