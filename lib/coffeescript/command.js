  ...
  compileScript = function(file, input, base = null) {
    ...
    try {
      ...
      if (opts.tokens) {
        ...
        return console.log(util.inspect(compiled, false, null));
