...
(function() {
  ...
  compileScript = function(file, input, base = null) {
    ...
    try {
      ...
      if (opts.tokens) {
        ...
        compiled = CoffeeScript.compile(task.input, merge(task.options, {
  ...
  parseOptions = function() {
    ...
    o.run = !(o.compile || o.print || o.map || o.prettier);
