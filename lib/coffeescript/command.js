  ...
  compileScript = function(file, input, base = null) {
    ...
    try {
      ...
      if (opts.tokens) {
        ...
        return console.log(util.inspect(CoffeeScript.ast(task.input, task.options), false, null));
      } else if (opts.run) {
