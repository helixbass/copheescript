...
(function() {
  ...
  grammar = {
    ...
    PostfixWhileSource: [
      o('POST_WHILE Expression',
      function() {
        return new While($2);
      }),
      o('POST_WHILE Expression WHEN Expression',
      function() {
        return new While($2,
      {
          guard: $4
      ...
      o('POST_WHILE ExpressionLine WHEN Expression',
      function() {
        return new While($2,
      {
          guard: $4
      ...
      o('POST_UNTIL Expression WHEN Expression',
      function() {
        return new While($2,
      {
          invert: true,
      ...
      o('POST_UNTIL ExpressionLine WHEN Expression',
      function() {
        return new While($2,
      {
          invert: true,
    ...
    While: [
      ...
      o('Statement  PostfixWhileSource',
      function() {
      ...
      o('Expression PostfixWhileSource',
      function() {
        return (Object.assign($2,
      {
          postfix: true
    ...
    For: [
      o('Statement    PostfixForBody',
      function() {
        $2.postfix = true;
        return $2.addBody($1);
      }),
      o('Expression   PostfixForBody',
      function() {
        $2.postfix = true;
        return $2.addBody($1);
      }),
    ...
    PostfixForBody: [
      ...
      o('POST_FOR Range BY Expression',
      function() {
        return new For([],
      {
          source: LOC(2)(new Value($2)),
