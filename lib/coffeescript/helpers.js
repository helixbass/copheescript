...
(function() {
  var attachCommentsToNode, buildLocationData, buildLocationHash, dump, expandLocationDataToInclude, extend, flatten, isArray, isBoolean, isFunction, isNumber, isPlainObject, isString, isToken, locationFields, ref, repeat, syntaxErrorToString, traverseBabylonAst, traverseBabylonAsts, util,
    splice = [].splice,
    indexOf = [].indexOf,
