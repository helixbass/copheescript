...
(function() {
  var attachCommentsToNode, buildLocationData, buildLocationHash, dump, extend, flatten, isArray, isBoolean, isNumber, isPlainObject, isString, locationFields, ref, repeat, syntaxErrorToString, traverseBabylonAst, traverseBabylonAsts, util,
    splice = [].splice,
  ...
  exports.traverseBabylonAst = traverseBabylonAst = function(node, func) {
