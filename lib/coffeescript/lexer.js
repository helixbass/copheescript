...
(function() {
  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    commentToken(chunk = this.chunk, {offsetInChunk = 0, nonInitial, dontShift, heregex} = {}) {
      var commentAttachment, commentAttachments, content, contents, getIndentSize, here, hereLeadingWhitespace, i, indent, indentSize, leadingNewLine, leadingNewlineOffset, leadingNewlinesLength, leadingWhitespace, length, match, matchIllegal, nonHere, placeholderToken, precedingNonCommentLines, prev, withLeadingWhitespace;
