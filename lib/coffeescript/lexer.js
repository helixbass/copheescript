...
(function() {
  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    mergeInterpolationTokens(tokens, options, fn) {
      var $, comment, converted, double, endOffset, firstIndex, heregex, i, indent, j, jsx, k, lastToken, len, len1, locationToken, lparen, placeholderToken, quote, ref, ref1, rparen, tag, token, tokensToPush, val, value;
  ...
  INSIDE_JSX = /^(?:[^\{<])*/; // Start of CoffeeScript interpolation.
