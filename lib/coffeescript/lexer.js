...
(function() {
  ...
  ({count, repeat, invertLiterate, merge, dump, attachCommentsToNode, throwSyntaxError, replaceUnicodeCodePointEscapes} = require('./helpers'));
  ...
  INSIDE_CSX = /^(?:[^\{<])*/; // Start of CoffeeScript interpolation.
