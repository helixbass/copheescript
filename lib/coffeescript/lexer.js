...
(function() {
  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    mergeInterpolationTokens(tokens, options, fn) {
      var $, comment, converted, double, firstEmptyStringIndex, firstIndex, heregex, i, indent, j, k, lastToken, len, len1, locationToken, lparen, placeholderToken, plusToken, quote, rparen, tag, token, tokensToPush, val, value;
