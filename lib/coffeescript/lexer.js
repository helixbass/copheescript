...
(function() {
  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    commentToken(chunk = this.chunk) {
      var comment, commentAttachment, commentAttachments, content, contents, here, i, leadingWhitespace, length, match, matchIllegal, newLine, offsetInChunk, placeholderToken, prev, withLeadingWhitespace;
