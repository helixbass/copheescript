...
(function() {
  ...
  ({count, repeat, invertLiterate, merge, dump, makeDelimitedLiteral, attachCommentsToNode, throwSyntaxError, getNumberValue, normalizeStringObject} = require('./helpers'));
  ...
  exports.Lexer = Lexer = (function() {
    class Lexer {
      ...
      commentToken(chunk = this.chunk, {offsetInChunk = 0, nonInitial, dontShift} = {}) {
        var comment, commentAttachment, commentAttachments, content, contents, here, i, leadingNewLine, leadingNewlineOffset, leadingNewlinesLength, leadingWhitespace, length, match, matchIllegal, placeholderToken, prev, withLeadingWhitespace;
        ...
        offsetInChunk += leadingWhitespace.length + (leadingNewlinesLength != null ? leadingNewlinesLength : 0);
        if (nonInitial == null) {
          nonInitial = false;
        }
          ...
          for (i = j = 0, len = contents.length; j < len; i = ++j) {
            ...
            commentAttachment = {
              ...
              locationData: this.makeLocationData({
                offsetInChunk: offsetInChunk + leadingNewlineOffset,
                length
              })
            };
            if (dontShift) {
      ...
      regexToken() {
        var body, closed, comment, comments, end, flags, index, j, len, match, opts, origin, prev, ref, ref1, regex, tokens;
        switch (false) {
      ...
      mergeInterpolationTokens(tokens, options, fn) {
        var $, attachDouble, attachQuote, comment, converted, double, firstEmptyStringIndex, firstIndex, i, indent, j, k, lastToken, len, len1, locationToken, lparen, markFinalChunk, markIndent, markInitialChunk, placeholderToken, plusToken, preserveTagged, quote, rparen, tag, tags, token, tokensToPush, val, value;
      ...
      makeToken(tag, value, offsetInChunk = 0, length = value.length) {
        return [tag, value, this.makeLocationData({offsetInChunk, length})];
      }
