...
(function() {
  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    commentToken(chunk = this.chunk, {offsetInChunk = 0, nonInitial, dontShift} = {}) {
      var commentAttachment, commentAttachments, content, contents, here, hereLeadingWhitespace, i, isIndented, leadingNewLine, leadingNewlineOffset, leadingNewlinesLength, leadingWhitespace, length, match, matchIllegal, nonHere, placeholderToken, precedingNonCommentLines, prev, withLeadingWhitespace;
      ...
      isIndented = (leadingWhitespace) => {
        var indentSize, lastNewlineIndex;
      ...
      if (here != null) {
        offsetInChunk += hereLeadingWhitespace.length;
      }
      ...
      commentAttachments = (function() {
        ...
        for (i = j = 0, len = contents.length; j < len; i = ++j) {
          ({content, length, leadingWhitespace} = contents[i]);
          if (i !== 0) {
            nonInitial = true;
          }
      ...
      if (!prev) {
        ...
        this.lineToken(this.chunk.slice(withLeadingWhitespace.length));
    ...
    regexToken() {
      ...
      if (comments != null ? comments.length : void 0) {
        for (j = 0, len = comments.length; j < len; j++) {
          ...
          this.commentToken(comment, opts);
        }
      }
      return end;
    }
