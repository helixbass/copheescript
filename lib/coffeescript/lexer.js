...
(function() {
  ...
  ({count, repeat, invertLiterate, merge, dump, attachCommentsToNode, throwSyntaxError, getNumberValue} = require('./helpers'));
  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    matchWithInterpolations(regex, delimiter, closingDelimiter, interpolators) {
      var braceInterpolator, close, column, firstToken, index, interpolationOffset, interpolator, lastToken, line, match, nested, offset, offsetInChunk, open, ref, rest, str, strPart, tokens;
    ...
    mergeInterpolationTokens(tokens, options, fn) {
      var comment, converted, firstEmptyStringIndex, firstIndex, i, j, k, lastToken, len, len1, locationToken, lparen, placeholderToken, plusToken, rparen, tag, token, tokensToPush, val, value;
      if (tokens.length > 1) {
