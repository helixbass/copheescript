...
(function() {
  ...
  ({count, repeat, invertLiterate, merge, dump, makeDelimitedLiteral, attachCommentsToNode, throwSyntaxError, getNumberValue, throwSyntaxError, replaceUnicodeCodePointEscapes} = require('./helpers'));
  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    commentToken(chunk = this.chunk, {offsetInChunk = 0, nonInitial, dontShift, heregex} = {}) {
      var commentAttachment, commentAttachments, content, contents, getIndentSize, here, hereLeadingWhitespace, hereTrailingWhitespace, i, indent, indentSize, leadingNewLine, leadingNewlineOffset, leadingNewlinesLength, leadingWhitespace, length, match, matchIllegal, nonHere, placeholderToken, precedingNonCommentLines, prev, withLeadingWhitespace;
      ...
      if (here != null) {
        ...
        contents = content.split('\n').map(function(line, index) {
          ...
          ret = {
            ...
            content,
            leadingWhitespace: `${precedingNonCommentLines}${leadingWhitespace}`
          };
          precedingNonCommentLines = '';
          return ret;
      ...
      offsetInChunk += leadingNewlinesLength != null ? leadingNewlinesLength : 0;
      if (nonInitial == null) {
        nonInitial = false;
      }
      commentAttachments = (function() {
        ...
        for (i = j = 0, len = contents.length; j < len; i = ++j) {
          ...
          commentAttachment = {
            ...
            indented: indentSize > this.indent,
            outdented: indentSize < this.indent,
            indentSize,
            indent
          };
          if (dontShift) {
