...
(function() {
  ...
  ({count, starts, compact, repeat, invertLiterate, merge, dump, attachCommentsToNode, locationDataToString, throwSyntaxError, getNumberValue} = require('./helpers'));
