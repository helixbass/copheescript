  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    clean(code) {
      ...
      if (WHITESPACE.test(code)) {
        code = `\n${code}`;
        this.chunkLine--; // TODO: should update @chunkOffset?
      }
      if (this.literate) {
      ...
      if (here != null) {
        ...
        contents = content.split('\n').map(function(line, index) {
          ...
          ret = {
            ...
            content,
            leadingWhitespace: `${precedingNonCommentLines}${index === 0 ? leadingNewlines : ''}${leadingWhitespace}`
          };
          precedingNonCommentLines = '';
          return ret;
    ...
    mergeInterpolationTokens(tokens, options, fn) {
      var $, comment, converted, double, firstIndex, heregex, i, indent, j, k, lastToken, len, len1, locationToken, lparen, placeholderToken, quote, rparen, tag, token, tokensToPush, val, value;
