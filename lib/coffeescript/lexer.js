...
(function() {
  ...
  ({count, repeat, invertLiterate, merge, dump, makeDelimitedLiteral, attachCommentsToNode, throwSyntaxError, getNumberValue} = require('./helpers'));
