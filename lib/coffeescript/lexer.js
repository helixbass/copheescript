...
(function() {
  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    commentToken(chunk = this.chunk) {
      var comment, commentAttachment, commentAttachments, content, contents, here, i, leadingNewlinesLength, leadingWhitespace, length, match, matchIllegal, newLine, offsetInChunk, placeholderToken, prev, withLeadingWhitespace;
