...
(function() {
  ...
  exports.Lexer = Lexer = class Lexer {
    ...
    commentToken(chunk = this.chunk, {offsetInChunk = 0} = {}) {
      var comment, commentAttachment, commentAttachments, content, contents, here, i, leadingNewlinesLength, leadingWhitespace, length, match, matchIllegal, newLine, placeholderToken, prev, withLeadingWhitespace;
    ...
    regexToken() {
      var body, closed, comment, commentIndex, end, flags, index, leadingWhitespace, match, matchedComment, origin, prev, ref, ref1, regex, tokens, withLeadingWhitespace;
      switch (false) {
