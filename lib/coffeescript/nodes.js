...
(function() {
  ...
  ({compact, flatten, extend, merge, del, starts, ends, some, addDataToNode, attachCommentsToNode, locationDataToString, throwSyntaxError, getNumberValue, dump, locationDataToBabylon, isArray, isString} = require('./helpers'));
...
// multiline need to be indented.
  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      ...
      constructor(variable1, value1, context, opts = {}) {
        super();
        this.variable = variable1;
        this.value = value1;
        if (isString(context)) {
          ...
          opts = (context != null ? context : context = {});
        }
        ({context: this.context, param: this.param, subpattern: this.subpattern, operatorToken: this.operatorToken, moduleDeclaration: this.moduleDeclaration, shorthand: this.shorthand} = opts);
      }
