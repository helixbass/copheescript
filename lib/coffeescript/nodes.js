...
// multiline need to be indented.
    ...
    class Call extends Base {
      ...
      CSXElementToAst({tagName, attributes, content, o}) {
        ...
        openingElement = Object.assign({
          ...
          name: this.variable.unwrap().ast(o),
          selfClosing: !content,
          attributes: []
        ...
        if (content) {
          ...
          closingElement = Object.assign({
            ...
            name: Object.assign(this.variable.unwrap().ast(o), locationDataToAst(tagName.closingTagNameLocationData))
      ...
      CSXToAst(o) {
        ...
        return Object.assign(this.CSXElementToAst({tagName, attributes, content, o}), {
          // else
  ...
  exports.ModuleDeclaration = ModuleDeclaration = (function() {
    class ModuleDeclaration extends Base {
      ...
      checkScope(o, moduleDeclarationType) {
        var ref1;
        if (o.topLevel || ((ref1 = o.indent) != null ? ref1.length : void 0) !== 0) {
          return;
        }
  ...
  exports.ImportDeclaration = ImportDeclaration = class ImportDeclaration extends ModuleDeclaration {
    ...
    ast(o) {
      this.checkScope(merge(o, {topLevel: this.topLevel}), 'import');
      o.importedSymbols = [];
      return super.ast(o);
    }
  ...
  exports.ExportNamedDeclaration = ExportNamedDeclaration = class ExportNamedDeclaration extends ExportDeclaration {
    ast(o) {
      this.checkScope(merge(o, {topLevel: this.topLevel}), 'export');
      this.clause.moduleDeclaration = 'export';
      return super.ast(o);
    }
