...
// multiline need to be indented.
  ...
  exports.For = For = (function() {
    class For extends While {
      ...
      _compileToBabylon(o) {
        var index, indexVar, keyVar, lengthVar, name, scope, shouldWrapInAssignToKeyVar, sourceVar, wrapInAssignToKeyVar;
        ({scope} = o);
        ...
        if (this.object) {
          return this.compileObjectToBabylon({o, name, keyVar, sourceVar});
        }
