...
(function() {
  ...
  ({compact, flatten, extend, merge, del, starts, ends, some, addDataToNode, attachCommentsToNode, locationDataToString, throwSyntaxError, replaceUnicodeCodePointEscapes, locationDataToBabel, babelLocationFields, isFunction, isPlainObject, isBoolean, getNumberValue, dump, mapValues, traverseBabylonAst, makeDelimitedLiteral, mergeBabylonLocationData, mergeLocationData, assignEmptyTrailingLocationData} = require('./helpers'));
    ...
    class Base {
      ...
      compileToBabylon(o, level) {
        ...
        return this.withBabylonComments(o, (() => {
          ...
          return this.withBabelLocationData(node._compileToBabylon(o));
        })());
      }
...
// compact(
      ...
      withEmptyBabylonLocationData(compiled) {
        return this.withBabelLocationData(compiled, emptyLocationData);
      }
      ...
      withCopiedBabylonLocationData(compiled, other) {
        var field, j, len1;
        for (j = 0, len1 = babelLocationFields.length; j < len1; j++) {
          field = babelLocationFields[j];
  ...
  exports.Block = Block = (function() {
    class Block extends Base {
      ...
      compileRootToBabylon(o) {
        ...
        program = this.includeCommentsInLocationData(this.withBabelLocationData({
          type: 'Program',
          sourceType: 'module',
          body: compiledBody,
          directives: this.directives,
      ...
      rootToAst(o) {
        ...
        program = this.withBabelLocationData({
          type: 'Program',
          sourceType: 'module',
          body,
          directives: this.directives
        ...
        for (j = 0, len1 = comments.length; j < len1; j++) {
          comment = comments[j];
          mergeBabylonLocationData(program, comment);
        }
        return this.withCopiedBabylonLocationData({
          type: 'File',
          program,
      ...
      _compileToBabylon(o) {
        ...
        return this.includeCommentsInLocationData(this.withBabelLocationData(this.withAstType({body, directives: this.directives})));
      }
...
// multiline need to be indented.
    ...
    class Value extends Base {
      ...
      _toAst(o) {
        ...
        for (propIndex = j = 0, len1 = props.length; j < len1; propIndex = ++j) {
          ...
          ret = prop instanceof Slice && o.compiling ? prop.compileValueToBabylon(o, ret) : mergeBabylonLocationData(prop.withBabelLocationData({
          ...
          if (this.base instanceof Parens && (this.base.locationData != null) && propIndex === 0) {
            mergeBabylonLocationData(ret, locationDataToBabel(this.base.locationData));
          }
        }
        return ret;
      }
    ...
    class Call extends Base {
      ...
      CSXToAst(o) {
        ...
        return {
          ...
          } : (openingElement = tagName.withBabelLocationData({
            ...
            if (attributes.base instanceof Arr) {
              ...
              for (j = 0, len1 = ref1.length; j < len1; j++) {
                ...
                if (attr instanceof IdentifierLiteral) {
                  results.push(attr.withBabelLocationData({
                    type: 'JSXAttribute',
                    name: compiled
                  }));
                } else {
          ...
          })()), content ? (closingElementBabylonLocationData = locationDataToBabel(this.args.closingBracketLocationData), closingElement = this.withCopiedBabylonLocationData({
  ...
  exports.Slice = Slice = (function() {
    class Slice extends Base {
      ...
      compileValueToBabylon(o, compiledValue) {
        ...
        return this.withBabelLocationData({
          type: 'CallExpression',
          callee: {
            type: 'MemberExpression',
          ...
          properties: (function() {
            ...
            for (j = 0, len1 = ref1.length; j < len1; j++) {
              ...
              results.push((() => {
                ...
                return prop.withBabelLocationData({
                  type: 'ObjectProperty',
                  key: compiledKey,
  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      ...
      CSXAttributeToAst(o) {
        return {
          type: 'JSXAttribute',
          name: this.variable.base.withBabelLocationData({
            type: 'JSXIdentifier',
          ...
          value: (() => {
            ...
            return val.withBabelLocationData({
  ...
  exports.Op = Op = (function() {
    ...
    class Op extends Base {
      ...
      astChildren(o) {
        switch (false) {
          case this.operator !== 'new':
            return {
              callee: this.first.toAst(o, LEVEL_OP),
              arguments: []
            };
          case !this.isUnary():
            return {
              argument: this.isYield() || this.isAwait() ? this.first.unwrap().value !== '' ? this.first.toAst(o, LEVEL_OP) : void 0 : this.first.toAst(o, LEVEL_OP)
            };
          default:
            return {
      ...
      astProps(o) {
        if (this.operator === 'new' || this.isAwait()) {
          return {};
        }
        if (this.isYield()) {
          return {
    ...
    class Try extends Base {
      ...
      _toAst(o) {
        ...
        return {
          ...
          handler: compiling ? placeholder ? (this.recovery || this).withBabelLocationData({
            type: 'CatchClause',
            param: placeholder.compileToBabylon(o),
            body: (this.recovery || this.withLocationData(new Block)).compileToBabylon(o, LEVEL_TOP)
          }) : void 0 : this.recovery ? this.recovery.withBabelLocationData({
            type: 'CatchClause',
      ...
      CSXContentToAst(o) {
        ...
        for (j = 0, len1 = elements.length; j < len1; j++) {
          ...
          if (element instanceof StringLiteral) {
            ...
            results.push(element.withBabelLocationData({
              type: 'JSXExpressionContainer',
              expression: (function() {
          ...
          cases: [
            ...
            results1;
                  ...
                  for (testIndex = k = 0, len2 = tests.length; k < len2; testIndex = ++k) {
                    ...
                    compiledCase = test.withBabelLocationData((() => {
                      if ((() => {
                        var lastExpr;
                        if (!compiling) {
                          return false;
            ...
            LEVEL_TOP).body : []
                    ...
                    if (compiledCase.consequent.length) {
                      mergeBabylonLocationData(compiledCase,
            ...
            ...(((ref3 = this.otherwise) != null ? ref3.expressions.length : void 0) ? [
              this.otherwise.withBabelLocationData({
                type: 'SwitchCase',
                test: null,
