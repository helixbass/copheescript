...
// multiline need to be indented.
  ...
  exports.Call = Call = (function() {
    class Call extends Base {
      ...
      CSXElementToAst({tagName, attributes, openingElementLocationData, closingElementLocationData}) {
        ...
        openingElement = Object.assign({
          ...
          attributes: flatten((function() {
            ...
            for (j = 0, len1 = ref1.length; j < len1; j++) {
              object = ref1[j];
              results.push(this.getCSXAttributeAst(object));
            }
            return results;
          }).call(this))
        }, openingElementLocationData);
      ...
      CSXToAst() {
        var attributes, closingElementLocationData, content, openingElementLocationData, tagName;
        [attributes, content] = this.args;
        ...
        return Object.assign(tagName.value.length ? this.CSXElementToAst({tagName, attributes, openingElementLocationData, closingElementLocationData}) : this.CSXFragmentToAst({openingElementLocationData, closingElementLocationData}), {
          children: []
        });
      }
