...
// multiline need to be indented.
  ...
  STRING_ESCAPES = RegExp(`((?:\\\\\\\\)+)|(\\\\u{[\\da-fA-F]+})|(\\\\u[\\da-fA-F]{4})|(\\\\x[\\da-fA-F]{2})|(\\\\[^\\n${' ' // Consume (and preserve) an even number of backslashes.
}])`, "g");

  processEscapes = function(string) {
    return string.replace(STRING_ESCAPES, function(match, doubleBackslashes, unicodeCodePointEscape, unicodeEscape, hexEscape, escape) {
