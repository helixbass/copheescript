...
// multiline need to be indented.
          ...
          properties: (function() {
            ...
            for (j = 0, len1 = ref1.length; j < len1; j++) {
              ...
              results.push({
                ...
                shorthand: !!shorthand,
                computed: variable instanceof Value && variable.base instanceof ComputedPropertyName
              });
            }
            return results;
          }).call(this)
  ...
  exports.While = While = (function() {
    class While extends Base {
      ...
      wrapInResultAccumulatingBlock({o, resultsVar, cachedSourceVarAssign}) {
        return (compiled) => {
          if (!(this.returns || cachedSourceVarAssign)) {
            return compiled;
          }
          return [
  ...
  exports.For = For = (function() {
    class For extends While {
      ...
      _compileToBabylon(o) {
        var cachedSourceVarAssign, index, indexVar, keyVar, name, resultsVar, scope, sourceVar;
        ({scope} = o);
        ...
        return this.wrapInResultAccumulatingBlock({o, resultsVar, cachedSourceVarAssign})(_extends1({
          type: 'ForStatement'
        }, (this.range ? this.source.base.compileToBabylon(merge(o, {indexVar, keyVar})) : this.compileForPartsToBabylon({o, keyVar, indexVar, sourceVar})), {
          body: this.compileBodyToBabylon(o)
        }));
      }
      ...
      compileForPartsToBabylon({o, keyVar, indexVar, sourceVar}) {
        ...
        return {
          ...
          update: wrapInAssignToKeyVar(new Op('++', indexVar, null, shouldWrapInAssignToKeyVar)).compileToBabylon(o)
        };
      }
