    ...
    class RegexLiteral extends Literal {
      ...
      _toAst(o) {
        ...
        return {
          ...
          extra: {
            raw: o.compiling ? this.value : `${this.delimiter}${this.originalValue}${this.delimiter}${this.flags}`,
            rawValue: void 0
          }
        };
      }
...
// multiline need to be indented.
  ...
  exports.RegexWithInterpolations = RegexWithInterpolations = (function() {
    ...
    RegexWithInterpolations.prototype.astType = 'RegExpLiteral';
