...
(function() {
  ...
  ({compact, flatten, extend, merge, del, starts, ends, some, addDataToNode, attachCommentsToNode, locationDataToString, throwSyntaxError, getNumberValue, dump, locationDataToBabylon} = require('./helpers'));
  ...
  exports.Block = Block = (function() {
    class Block extends Base {
      ...
      compileScopeAssignedVariablesToBabylon(o) {
        ...
        ref1 = o.scope.assignedVariables();
        results = [];
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          ({name, value} = ref1[j]);
          results.push(this.withEmptyBabylonLocationData({
      ...
      _compileToBabylon(o) {
        ...
        return {
          ...
          elements: (function() {
            ...
            for (j = 0, len1 = ref1.length; j < len1; j++) {
              obj = ref1[j];
              results.push(obj.compileToBabylon(o));
            }
            return results;
          }).call(this)
        };
  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      constructor(variable1, value1, context1, options = {}) {
        ...
        ({param: this.param, subpattern: this.subpattern, operatorToken: this.operatorToken, moduleDeclaration: this.moduleDeclaration, shorthand: this.shorthand} = options);
      }
