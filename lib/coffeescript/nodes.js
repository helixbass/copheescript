...
// compact(
      ...
      toAst() {
        return this.withBabylonLocationData(this.withAstType(this._toAst()));
      }
      ...
      getAstChildren() {
        var item, j, len1, obj, prop, ref1, ref2, val;
        obj = {};
        ref2 = (ref1 = this.astChildren) != null ? ref1 : this.children;
      ...
      _toAst() {
        return {...this.getAstChildren(), ...this.getAstProps()};
      }
