  ...
  exports.Base = Base = (function() {
    class Base {
      ...
      withBabylonLocationData(compiled, node) {
        ...
        if (!(locationData && compiled && !Array.isArray(compiled))) {
          return compiled;
        }
      ...
      expandThisParams(o) {
        ...
        this.eachParamName(function(name, node, param, obj) {
          ...
          if (node.this) {
            ...
            return thisAssignments.push(param.withLocationData(new Assign(node, target)));
          }
        });
  ...
  exports.Op = Op = (function() {
    ...
    class Op extends Base {
      ...
      compileUnaryToBabylon(o) {
        ...
        return {
          type: (ref1 = this.operator) === '++' || ref1 === '--' ? 'UpdateExpression' : 'UnaryExpression',
  ...
  exports.Parens = Parens = (function() {
    class Parens extends Base {
      ...
      _compileToBabylon(o) {
        ...
        return expr.compileToBabylon(o, LEVEL_PAREN);
      }
  ...
  exports.For = For = (function() {
    class For extends While {
      ...
      _compileToBabylon(o) {
        ...
        indexVar = this.object && index || this.withLocationData(new IdentifierLiteral(scope.freeVariable('i', {
          single: true
        })));
        ...
        if (!this.range) {
          ...
          if (name) {
            this.body.expressions.unshift(this.withLocationData(new Assign(name, new Value(sourceVar, [new Index(keyVar)]))));
          }
        }
        if (this.object) {
      ...
      compileForPartsToBabylon({o, keyVar, indexVar, sourceVar, stepVar}) {
        ...
        lengthVar = this.withLocationData(new IdentifierLiteral(o.scope.freeVariable('len'))); // unless @step and stepNum? and down
        ...
        return {
          init: this.withLocationData(new Sequence([wrapInAssignToKeyVar(new Assign(indexVar, new NumberLiteral('0'))), new Assign(lengthVar, new Value(sourceVar, [new Access(new PropertyName('length'))]))])).compileToBabylon(o),
