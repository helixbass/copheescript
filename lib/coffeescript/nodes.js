...
// multiline need to be indented.
  ...
  exports.Obj = Obj = (function() {
    class Obj extends Base {
          ...
          properties: (function() {
            ...
            for (j = 0, len1 = ref1.length; j < len1; j++) {
              ...
              results.push((() => {
                ...
                if (prop instanceof Splat) {
                  return prop.compileToBabylon(o);
                }
      ...
      reorderProperties() {
        var lastIndex, objProps, prevLast, prop, props, splatProps;
        props = this.properties;
        ...
        return (this.objects = this.properties = [...objProps, ...splatProps].map(function(prop, index) {
          if (index !== lastIndex) {
            return prop;
          }
  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      ...
      compileDestructuring(o) {
        var assignObjects, assigns, code, compSlice, compSplice, complexObjects, expIdx, expans, fragments, hasObjAssigns, i, isExpans, isObject, isSplat, leftObjs, loopObjects, obj, objIsUnassignable, objects, olen, processObjects, ref, refExp, restVar, rightObjs, slicer, splats, splatsAndExpans, top, value, vvar, vvarText;
        top = o.level === LEVEL_TOP;
        ({value} = this);
        ({objects} = this.variable.base);
        olen = objects.length;
  ...
  exports.Splat = Splat = (function() {
    class Splat extends Base {
      ...
      _compileToBabylon(o) {
        return {
          type: this.csx ? 'JSXSpreadAttribute' : this.lhs ? 'RestElement' : 'SpreadElement',
