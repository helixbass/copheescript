  ...
  exports.StringWithInterpolations = StringWithInterpolations = (function() {
    class StringWithInterpolations extends Base {
      ...
      extractElementsAndComments() {
        ...
        return {elements, salvagedComments};
      }

      _compileToBabylon(o) {
        var element, elements, expressions, first, index, j, justSawInterpolation, last, lastElement, len1, quasis, ref1, ref2, salvagedComments;
        ({elements, salvagedComments} = this.extractElementsAndComments());
        [first] = elements;
      ...
      compileNode(o) {
        var code, element, elements, fragments, j, len1, salvagedComments, wrapped;
        if (this.csxAttribute) {
