...
// compact(
  ...
  exports.StringLiteral = StringLiteral = class StringLiteral extends Literal {
    ...
    delimit(val, opts = {}) {
      ...
      return makeDelimitedLiteral(val, merge({delimiter: this.delimiter, double: this.double}, opts));
    }
...
// multiline need to be indented.
  ...
  exports.ObjectProperty = ObjectProperty = class ObjectProperty extends Base {
    ...
    astProperties(o) {
      var isComputedPropertyName, ref1, ref2;
      ...
      return {
        ...
        //     @key.ast o
        key: this.key.ast(o),
        value: (ref1 = (ref2 = this.value) != null ? ref2.ast(o) : void 0) != null ? ref1 : this.key.ast(o),
  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      constructor(variable1, value1, options = {}) {
        ...
        this.variable = variable1;
        this.value = value1;
        ({context: this.context, param: this.param, subpattern: this.subpattern, operatorToken: this.operatorToken, moduleDeclaration: this.moduleDeclaration, originalContext: this.originalContext = this.context} = options);
        this.propagateLhs();
      }
      ...
      astProperties(o) {
        ...
        if (!this.isDefaultAssignment()) {
          ret.operator = (ref1 = (o.compiling ? this.context : this.originalContext)) != null ? ref1 : '=';
        }
        return ret;
      }
  ...
  exports.Op = Op = (function() {
    ...
    class Op extends Base {
      constructor(op, first, second, flip, {
          invertOperator,
          originalOperator: originalOperator = op
        } = {}) {
      ...
      astProperties(o) {
        ...
        switch (false) {
          case !this.isUnary():
            argument = this.isYield() || this.isAwait() ? this.first.unwrap().value !== '' ? firstAst : null : firstAst;
            if (this.isAwait()) {
              return {argument};
            }
            if (this.isYield()) {
  ...
  makeDelimitedLiteral = function(body, options = {}) {
    ...
    regex = options.justEscapeDelimiter ? RegExp(`\\\\?(${options.delimiter})`, "g") : RegExp(`(\\\\\\\\)|(\\\\0(?=[1-7]))|\\\\?(${options.delimiter})|\\\\?(?:(\\n)|(\\r)|(\\u2028)|(\\u2029))|(\\\\.)`, "g");
    // Escaped backslash.
