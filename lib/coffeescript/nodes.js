...
(function() {
  ...
  exports.StringLiteral = StringLiteral = class StringLiteral extends Literal {
    ...
    astProperties() {
      return {
        value: processEscapes(this.collapseNewlines(this.originalValue)),
        extra: {
