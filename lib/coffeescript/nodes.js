...
(function() {
  ...
  ({compact, flatten, extend, merge, del, starts, ends, some, addDataToNode, attachCommentsToNode, locationDataToString, throwSyntaxError, getNumberValue, dump, locationDataToBabylon, isArray, isBoolean} = require('./helpers'));
...
// multiline need to be indented.
  ...
  exports.Obj = Obj = (function() {
    class Obj extends Base {
      ...
      constructor(props, generated, lhs1) {
        super();
        this.generated = generated;
        this.lhs = lhs1;
        if ((this.generated != null) && !isBoolean(this.generated)) {
          ({generated: this.generated, lhs: this.lhs} = this.generated);
        }
