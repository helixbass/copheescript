...
(function() {
  ...
  ({compact, flatten, extend, merge, del, starts, ends, some, addDataToNode, attachCommentsToNode, locationDataToString, throwSyntaxError, getNumberValue, dump, locationDataToBabylon, isArray, isBoolean, isPlainObject, mapValues, traverseBabylonAst, babylonLocationFields, isFunction, makeDelimitedLiteral, mergeBabylonLocationData, mergeLocationData, replaceUnicodeCodePointEscapes, assignEmptyTrailingLocationData} = require('./helpers'));
    ...
    class Op extends Base {
      constructor(op, first, second, flip, {
        ...
        if (op === 'new') {
          ...
          if (firstCall instanceof Code && firstCall.bound || first instanceof Op && first.operator === 'do') {
