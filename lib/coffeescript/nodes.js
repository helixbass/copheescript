    ...
    class Base {
      ...
      compileToBabylon(o, level) {
        ...
        if (!(o.level === LEVEL_TOP || !node.isStatement(o))) {
          return this.compileClosureToBabylon(o);
        }
        return this.withBabylonLocationData(this._compileToBabylon(o));
      }
    ...
    class Return extends Base {
      ...
      _compileToBabylon(o) {
        return {
          ...
          argument: this.expression.compileToBabylon(o)
        };
      }
...
// multiline need to be indented.
  ...
  exports.Range = Range = (function() {
    class Range extends Base {
      ...
      compileForToBabylon(o) {
        ...
        keyVar = del(o, 'keyVar');
        return {
          init: this.from.withLocationData(new Assign(keyVar, new Assign(indexVar, this.from))).compileToBabylon(o),
          test: this.to.withLocationData(new Op(`<${this.equals}`, indexVar, this.to)).compileToBabylon(o),
          update: this.withLocationData(new Assign(keyVar, new Op('++', indexVar, null))).compileToBabylon(o)
        };
      }
  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      ...
      compileDestructuringToBabylon(o) {
        var assigns, expans, expansIndex, getSlice, i, isExpans, leftObjs, obj, objects, processObjects, rightObjs, slicer, value;
        ({value} = this);
        ...
        slicer = function(type) {
          return function(slicee, ...args) {
            ...
            return new Value(new Call(slice, [
              slicee,
              ...((function() {
                var j,
              len1,
        ...
        if (isExpans) {
          ...
          if (rightObjs.length !== 0) {
            processObjects(rightObjs, getSlice(value, rightObjs.length * -1));
          }
        }
  ...
  exports.Op = Op = (function() {
    ...
    class Op extends Base {
      ...
      compileExistenceToBabylon(o, checkOnlyUndefined) {
        return this.withLocationData(new If(new Existence(this.first, checkOnlyUndefined), this.first, {
          type: 'if'
    ...
    class Existence extends Base {
      ...
      _compileToBabylon(o) {
        ...
        comparison = this.expression.unwrap() instanceof IdentifierLiteral && !o.scope.check(this.expression.unwrap().value) ? (() => {
          ...
          comparisonAgainstUndefined = this.withLocationData(new Op('!==', new Op('typeof', this.expression), new StringLiteral("'undefined'")));
          if (this.comparisonTarget === 'undefined') {
            return comparisonAgainstUndefined;
          }
          return this.withLocationData(new Op('&&', comparisonAgainstUndefined, new Op('!==', this.expression, new NullLiteral)));
        })() : (op = new Op(this.negated ? '===' : '!==', this.expression, this.comparisonTarget === 'null' ? new NullLiteral : new UndefinedLiteral), this.comparisonTarget === 'null' ? op.operator = this.negated ? '==' : '!=' : void 0, op);
        return this.withLocationData(o.level <= LEVEL_COND ? comparison : new Parens(comparison)).compileToBabylon(o);
      }
  ...
  exports.For = For = (function() {
    class For extends While {
      ...
      _compileToBabylon(o) {
        ...
        indexVar = this.object && index || (name || this).withLocationData(new IdentifierLiteral(scope.freeVariable('i', {
          single: true
        })));
        ...
        if (this.object) {
          return this.compileObjectToBabylon({o, name, keyVar, sourceVar, resultsVar, cachedSourceVarAssign});
        }
        ...
        return this.wrapInResultAccumulatingBlock({o, resultsVar, cachedSourceVarAssign, cachedStepVarAssign})(_extends1({
          type: 'ForStatement'
        }, (this.range ? this.source.base.compileToBabylon(merge(o, {indexVar, keyVar})) : this.compileForPartsToBabylon({o, keyVar, indexVar, sourceVar, stepVar})), {
          body: this.compileBodyToBabylon(o)
        }));
      }
  ...
  utility_babylon = function(name, o) {
    var ref, root;
    ({root} = o.scope);
    if (name in root.utilities) {
      return root.utilities[name];
