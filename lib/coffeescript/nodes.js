...
(function() {
  ...
  ({compact, flatten, extend, merge, del, starts, ends, some, addDataToNode, attachCommentsToNode, locationDataToString, throwSyntaxError, getNumberValue, dump, locationDataToBabylon, isArray, isBoolean, isPlainObject, mapValues, traverseBabylonAst, babylonLocationFields, isFunction} = require('./helpers'));
  ...
  exports.Base = Base = (function() {
    class Base {
      ...
      withAstType(ast) {
        return {
          type: (() => {
            ...
            return (ref1 = typeof this.astType === "function" ? this.astType() : void 0) != null ? ref1 : this.astType;
          })(),
          ...ast
        };
      }
      ...
      toAst(o, level) {
        ...
        return this.withBabylonLocationData(this.withAstType(this._toAst(o)));
      }

      getAstProps() {
        var j, len1, obj, prop, ref1;
        if (isFunction(this.astProps)) {
          return this.astProps();
        }
        obj = {};
        ref1 = this.astProps;
      ...
      _toAst(o) {
        return {...this.getAstChildren(o), ...this.getAstProps()};
      }
      ...
      _compileToBabylon(o) {
        ...
        return this.withAstType(this._toAst(merge(o, {
          compilingBabylon: true
        })));
      }
...
// compact(
  ...
  exports.NumberLiteral = NumberLiteral = (function() {
    ...
    NumberLiteral.prototype._compileToBabylon = Base.prototype._compileToBabylon;
  ...
  exports.StringLiteral = StringLiteral = class StringLiteral extends Literal {
    ...
    _compileToBabylon(o) {
      ...
      return this.withAstType(this._toAst(o));
    }
  ...
  exports.Value = Value = (function() {
    class Value extends Base {
      ...
      _compileToBabylon(o) {
        ...
        for (j = 0, len1 = props.length; j < len1; j++) {
          prop = props[j];
          ret = prop instanceof Slice ? prop.compileValueToBabylon(o, ret) : prop.withBabylonLocationData({ // TODO: should include location up through this prop
  ...
  exports.Super = Super = (function() {
    class Super extends Base {
      ...
      _compileToBabylon(o) {
        ...
        compiled = new Value(new SuperLiteral, this.accessor ? [this.accessor] : []).withLocationDataFrom(this).compileToBabylon(o);
        if (salvagedComments) {
        ...
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          ...
          if (this.lhs) {
            if (unwrappedObj instanceof Arr || unwrappedObj instanceof Obj) {
              results.push(unwrappedObj.lhs = true);
  ...
  exports.Class = Class = (function() {
    class Class extends Base {
      ...
      compileClassDeclarationToBabylon(o) {
        ...
        if (this.name) {
          id = this.withLocationData(new IdentifierLiteral(this.name));
        }
    ...
    class Try extends Base {
      ...
      _compileToBabylon(o) {
        ...
        return {
          ...
          handler: placeholder ? (this.recovery || this).withBabylonLocationData({
            type: 'CatchClause',
  ...
  exports.For = For = (function() {
    class For extends While {
      constructor(body, source) {
        var ref1, ref2;
        super();
        ({source: this.source, guard: this.guard, step: this.step, name: this.name, index: this.index, accumulateIndex: this.accumulateIndex, ownTag: this.ownTag} = source);
