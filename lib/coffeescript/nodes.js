...
// multiline need to be indented.
  ...
  exports.Existence = Existence = (function() {
    class Existence extends Base {
      ...
      _compileToBabylon(o) {
        var comparison, op;
        comparison = this.expression.unwrap() instanceof IdentifierLiteral && !o.scope.check(code) ? (() => {
  ...
  exports.For = For = (function() {
    class For extends While {
      ...
      _compileToBabylon(o) {
        var index, indexVar, keyVar, name, resultsVar, scope, sourceVar;
        ({scope} = o);
        ...
        if (this.object) {
          return this.compileObjectToBabylon({o, name, keyVar, sourceVar, resultsVar});
        }
        return this.wrapInResultAccumulatingBlock({o, resultsVar})(_extends1({
          type: 'ForStatement'
