...
// multiline need to be indented.
  ...
  exports.Switch = Switch = (function() {
    class Switch extends Base {
      ...
      astChildren(o) {
        var caseIndex, compiledCase, compiling, consequent, kase, lastCaseIndex, lastTestIndex, ref1, ref2, ref3, test, testIndex, tests;
        ({compiling} = o);
