      ...
      compileBodyToBabylon(o) {
        ...
        return flatten((function() {
          ...
          for (j = 0, len1 = ref1.length; j < len1; j++) {
            node = ref1[j];
            if (node.isStatement()) {
              results.push(node.compileToBabylon(o));
            } else {
              results.push({
...
// multiline need to be indented.
    ...
    class Op extends Base {
      ...
      _compileToBabylon(o) {
        ...
        return {
          ...
          operator: this.operator,
          right: this.second.compileToBabylon(o)
        };
      }
  ...
  exports.Existence = Existence = (function() {
    class Existence extends Base {
      ...
      _compileToBabylon(o) {
        var comparison;
        comparison = new Op('&&', new Op('!==', new Op('typeof', this.expression), new StringLiteral("'undefined'")), new Op('!==', this.expression, new NullLiteral));
        return (o.level <= LEVEL_COND ? comparison : new Parens(new Block([comparison]))).compileToBabylon(o);
      }
  ...
  exports.For = For = (function() {
    class For extends While {
      ...
      _compileToBabylon(o) {
        var index, indexVar, keyVar, lengthVar, name, resultsVar, scope, shouldWrapInAssignToKeyVar, sourceVar, wrapInAssignToKeyVar;
        ({scope} = o);
