...
// multiline need to be indented.
  ...
  exports.Call = Call = (function() {
    class Call extends Base {
      ...
      compileCSXToBabylon(o) {
        ...
        return _extends({}, (!tagName.value.length ? {
          type: 'JSXFragment',
  ...
  exports.Obj = Obj = (function() {
    class Obj extends Base {
      ...
      compileNode(o) {
        var answer, i, idt, indent, isCompact, ix, j, join, k, key, l, lastNode, len1, len2, len3, node, prop, props, ref1, splatProps, value;
        if (this.csx) {
  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      ...
      _compileToBabylon(o) {
        ...
        return _extends({}, (this.param || this.nestedLhs ? {
          type: 'AssignmentPattern'
        } : {
      ...
      compileNode(o) {
        var answer, compiledName, hasSplat, isValue, name, properties, prototype, ref1, ref2, ref3, ref4, ref5, val;
  ...
  exports.Parens = Parens = (function() {
    class Parens extends Base {
      ...
      _compileToBabylon(o) {
        ...
        return _extends({}, compiled, {
          extra: _extends({}, (ref1 = compiled.extra) != null ? ref1 : {}, {
            parenthesized: true
          })
        });
      }
  ...
  exports.For = For = (function() {
    class For extends While {
      ...
      _compileToBabylon(o) {
        ...
        return this.wrapInResultAccumulatingBlock({o, resultsVar, cachedSourceVarAssign, cachedStepVarAssign})(_extends({
          type: 'ForStatement'
