...
// compact(
  ...
  exports.Block = Block = (function() {
    class Block extends Base {
      ...
      astProperties(o) {
        var body, checkForDirectives, expression, expressionAst, j, len1, ref1;
    ...
    class If extends Base {
      ...
      astProperties(o) {
        ...
        properties = {
          ...
          alternate: this.isChain ? this.elseBody.unwrap().ast(o, isStatement ? LEVEL_TOP : LEVEL_COND) : this.elseBody != null ? (ref1 = (ref2 = this.elseBody) != null ? ref2.ast(o, LEVEL_TOP) : void 0) != null ? ref1 : null : !isStatement && compiling ? new UndefinedLiteral().ast(o) : null
        };
        if (!compiling) {
