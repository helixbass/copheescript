...
(function() {
  ...
  exports.Block = Block = (function() {
    class Block extends Base {
      ...
      _compileToBabylon(o) {
        var body, code, root, withDeclarations;
        root = del(o, 'root');
...
// multiline need to be indented.
  ...
  exports.Code = Code = (function() {
    class Code extends Base {
      ...
      _compileToBabylon(o) {
        ...
        return _extends1({
          type: this.isMethod ? 'ClassMethod' : 'FunctionExpression',
  ...
  exports.StringWithInterpolations = StringWithInterpolations = (function() {
    class StringWithInterpolations extends Base {
      ...
      _compileToBabylon(o) {
        var element, elements, expressions, first, index, j, last, len1, quasis, ref1, ref2, salvagedComments;
