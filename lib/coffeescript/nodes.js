...
(function() {
  ...
  ({compact, flatten, extend, merge, del, starts, ends, some, addDataToNode, attachCommentsToNode, locationDataToString, throwSyntaxError, getNumberValue, dump, locationDataToBabylon, isArray, isBoolean, isPlainObject, mapValues, traverseBabylonAst, babylonLocationFields} = require('./helpers'));
  ...
  exports.Base = Base = (function() {
    class Base {
      ...
      withBabylonComments(o, compiled) {
        var comment, last, rest, trailingComments;
        if (!this.comments) {
          return compiled;
        }
        trailingComments = (function() {
          ...
          for (j = 0, len1 = ref1.length; j < len1; j++) {
            ...
            results.push(new (comment.here ? HereComment : LineComment)(comment).compileToBabylon(o));
          }
          return results;
        }).call(this);
        if (isArray(compiled)) {
          [...rest] = compiled, [last] = splice.call(rest, -1);
          return [...rest, {...last, trailingComments}];
        } else if (compiled) {
          return {...compiled, trailingComments};
        } else {
    ...
    class Block extends Base {
      ...
      extractComments(compiled) {
        ...
        traverseBabylonAst(compiled, function(node) {
          ...
          return (node.trailingComments = null);
        });
        return comments;
      }

      compileRootToBabylon(o) {
        var comment, comments, compiledBody, j, len1, program;
        // @spaced   = yes
        ...
        comments = this.extractComments(compiledBody);
        if (program.body.length) {
          for (j = 0, len1 = comments.length; j < len1; j++) {
            ...
            comment.__prettierNodes = {
              ...
              __prettierHasFollowingNewline: true
            };
            break;
          }
        }
      ...
      _compileToBabylon(o) {
        ...
        return this.includeCommentsInLocationData(this.withBabylonLocationData({
      ...
      asExpressionStatement(compiled) {
        return this.includeCommentsInLocationData((function() {
          var ref1;
          if (!compiled.type) {
            return compiled;
          }
          if ((ref1 = compiled.type) === 'VariableDeclaration' || ref1 === 'ImportDeclaration') {
            return compiled;
          }
          return {
      ...
      includeCommentsInLocationData(node) {
        var end, start;
        ({start, end} = node);
        traverseBabylonAst(node, function({trailingComments}) {
          var comment, j, len1, results;
          if (!trailingComments) {
            return;
          }
          results = [];
          for (j = 0, len1 = trailingComments.length; j < len1; j++) {
            comment = trailingComments[j];
    ...
    class Return extends Base {
      ...
      _compileToBabylon(o) {
        ...
        return {
          ...
          argument: (ref1 = (ref2 = this.expression) != null ? ref2.compileToBabylon(o, LEVEL_PAREN) : void 0) != null ? ref1 : null
        };
      }
...
// multiline need to be indented.
  ...
  exports.Call = Call = (function() {
    class Call extends Base {
      ...
      _compileToBabylon(o) {
        ...
        return {
          type: this.isNew ? (this.variable instanceof Super ? this.variable.error("Unsupported reference to 'super'") : void 0, 'NewExpression') : 'CallExpression',
  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      ...
      compileDestructuringToBabylon(o) {
        var assigns, cachedValueAssign, complexObjects, expans, expansIndex, getSlice, getSplice, hasObjAssigns, i, isExpans, isSplat, leftObjs, loopObjects, obj, objIsUnassignable, objects, processObjects, pushAssign, rightObjs, slicer, splats, splatsAndExpans, value;
        ({value} = this);
      ...
      compileDestructuring(o) {
        var assignObjects, assigns, code, compSlice, compSplice, complexObjects, expIdx, expans, fragments, hasObjAssigns, i, isExpans, isSplat, leftObjs, loopObjects, obj, objIsUnassignable, objects, olen, processObjects, ref, refExp, restVar, rightObjs, slicer, splats, splatsAndExpans, top, value, vvar, vvarText;
        top = o.level === LEVEL_TOP;
        ({value} = this);
        ({objects} = this.variable.base);
        olen = objects.length;
  ...
  exports.Code = Code = (function() {
    class Code extends Base {
      ...
      _compileToBabylon(o) {
        var exprs, haveSplatParam, params, ref1, thisAssignments, wasEmpty, yieldNode;
        if (this.ctor) {
          if (this.isAsync) {
      ...
      addtlMethodBabylonFields(o) {
        ...
        compiledName = this.name.compileToBabylon(o);
        o.scope = methodScope;
        return {
    ...
    class Op extends Base {
      ...
      compileContinuationToBabylon(o) {
        ...
        return {
          ...
          argument: this.first.compileToBabylon(o, LEVEL_OP),
