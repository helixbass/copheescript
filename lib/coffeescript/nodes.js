...
(function() {
  ...
  var Access, Arr, Assign, AwaitReturn, BABYLON_STATEMENT_TYPES, Base, Block, BooleanLiteral, CSXAttribute, CSXAttributes, CSXElement, CSXExpressionContainer, CSXIdentifier, CSXTag, Call, Catch, Class, ClassProperty, Code, CodeFragment, ComputedPropertyName, DefaultLiteral, Directive, Elision, ExecutableClassBody, Existence, Expansion, ExportAllDeclaration, ExportDeclaration, ExportDefaultDeclaration, ExportNamedDeclaration, ExportSpecifier, ExportSpecifierList, Extends, For, FuncDirectiveReturn, FuncGlyph, HEREGEX_OMIT, HereComment, HoistTarget, IdentifierLiteral, If, ImportClause, ImportDeclaration, ImportDefaultSpecifier, ImportNamespaceSpecifier, ImportSpecifier, ImportSpecifierList, In, Index, InfinityLiteral, Interpolation, JS_FORBIDDEN, LEADING_BLANK_LINE, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, LineComment, Literal, ModuleDeclaration, ModuleSpecifier, ModuleSpecifierList, NEGATE, NO, NaNLiteral, NullLiteral, NumberLiteral, Obj, ObjectProperty, Op, Param, Parens, PassthroughLiteral, PropertyName, Range, RegexLiteral, RegexWithInterpolations, Return, Root, SIMPLENUM, SIMPLE_STRING_OMIT, STRING_OMIT, Scope, Sequence, Slice, Splat, StatementLiteral, StringLiteral, StringWithInterpolations, Super, SuperCall, SuperLiteral, Switch, SwitchCase, SwitchWhen, TAB, THIS, TRAILING_BLANK_LINE, TaggedTemplateCall, ThisLiteral, Throw, Try, UNICODE_CODE_POINT_ESCAPE, UNICODE_ESCAPE, UTILITIES, UTILITIES_BABYLON, UndefinedLiteral, Value, While, YES, YieldReturn, addDataToNode, assignEmptyTrailingLocationData, astAsBlock, astLocationFields, attachCommentsToNode, babylon, codePointToString, compact, del, dump, emptyLocationData, ends, extend, flatten, fragmentsToText, getNumberValue, greater, hasLineComments, indentInitial, isAstLocGreater, isBoolean, isFunction, isLiteralArguments, isLiteralThis, isLocationDataEndGreater, isLocationDataStartGreater, isNumber, isPlainObject, isUnassignable, jisonLocationDataToAstLocationData, lesser, locationDataToString, makeDelimitedLiteral, mapValues, merge, mergeAstLocationData, mergeLocationData, moveComments, multident, prettier, replaceUnicodeCodePointEscapes, shouldCacheOrIsAssignable, some, starts, throwSyntaxError, traverseBabylonAst, unfoldSoak, unicodeEscapesToString, unshiftAfterComments, utility, utilityBabylon,
    indexOf = [].indexOf,
    splice = [].splice,
    slice1 = [].slice;
  ...
  ({compact, flatten, extend, merge, del, starts, ends, some, addDataToNode, attachCommentsToNode, locationDataToString, throwSyntaxError, replaceUnicodeCodePointEscapes, astLocationFields, isFunction, isPlainObject, isBoolean, isNumber, dump, mapValues, traverseBabylonAst, assignEmptyTrailingLocationData, UNICODE_CODE_POINT_ESCAPE} = require('./helpers'));
...
// compact(
      ...
      sniffDirectives(expressions, {replace, notFinalExpression} = {}) {
        var directives, expr, index, lastIndex, unwrapped;
        directives = [];
        index = 0;
        ...
        while (expr = expressions[index]) {
          ...
          if ((unwrapped = typeof expr !== "undefined" && expr !== null ? typeof expr.unwrap === "function" ? expr.unwrap() : void 0 : void 0) instanceof PassthroughLiteral && unwrapped.generated) {
            index++;
            continue;
          }
      ...
      withAstLocationData(ast, node, {force} = {}) {
        ...
        return merge(ast, jisonLocationDataToAstLocationData(locationData));
      }
  ...
  exports.Block = Block = (function() {
    class Block extends Base {
      ...
      astProperties(o) {
        var body, checkForDirectives, expression, expressionAst, j, len1, ref1, unwrapped;
        ...
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          expression = ref1[j];
          if (!(!((unwrapped = expression != null ? expression.unwrap() : void 0) instanceof PassthroughLiteral && unwrapped.generated))) {
            continue;
          }
          expression.topLevel = this.isRootBlock;
          ...
          if ((expressionAst != null ? expressionAst.type : void 0) === 'Directive') {
            this.directives.push(expressionAst);
        ...
        // sourceType: 'module'
        return {body, directives: this.directives};
      }
...
// multiline need to be indented.
    ...
    class CSXElement extends Base {
      ...
      astProperties(o) {
        ...
        return Object.assign(this.isFragment() ? this.fragmentAstProperties(o) : this.elementAstProperties(o), {
          children: this.content && !(typeof (base1 = this.content.base).isEmpty === "function" ? base1.isEmpty() : void 0) ? (this.content.base.csx = true, compact(flatten([this.content.ast(o)]))) : [] //, LEVEL_LIST
        });
      }
  ...
  exports.Try = Try = (function() {
    class Try extends Base {
      ...
      astProperties(o) {
        var compiling, placeholder, ref1, ref2, ref3;
        ({compiling} = o);
        ...
        return {
          ...
          handler: (ref2 = (ref3 = this.catch) != null ? ref3.ast(o) : void 0) != null ? ref2 : null,
          // handler:
          //   if compiling
  ...
  exports.Switch = Switch = (function() {
    class Switch extends Base {
      ...
      casesAst(o) {
        var caseIndex, caseLocationData, cases, consequent, j, k, kase, l, lastCaseIndex, lastTestIndex, len1, len2, len3, ref1, ref2, results, test, testConsequent, testIndex, tests;
        cases = [];
        ...
        for (caseIndex = j = 0, len1 = ref1.length; j < len1; caseIndex = ++j) {
          ...
          if ((() => {
            ...
            if (caseIndex === lastCaseIndex && (this.otherwise == null)) {
              return false;
            }
        ...
        if ((ref2 = this.otherwise) != null ? ref2.expressions.length : void 0) {
          cases.push(new SwitchCase(null, this.otherwise, {
            invert: this.subject == null
          }).withLocationDataFrom(this.otherwise));
        }
        results = [];
      ...
      astProperties(o) {
        var compiling, ref1, ref2, ref3;
        ({compiling} = o);
        return {
          discriminant: (ref1 = (ref2 = (ref3 = this.subject) != null ? ref3 : compiling ? new BooleanLiteral('false') : null) != null ? ref2.ast(o, LEVEL_PAREN) : void 0) != null ? ref1 : null,
  ...
  SwitchCase = (function() {
    class SwitchCase extends Base {
      constructor(test1, block1, {trailing, invert} = {}) {
        super();
        this.test = test1;
        this.block = block1;
      ...
      astProperties(o) {
        var ref1, ref2, ref3, ref4, ref5;
        return {
          test: (ref1 = (ref2 = (o.compiling && this.invert ? (ref3 = this.test) != null ? ref3.invert() : void 0 : this.test)) != null ? ref2.ast(o, LEVEL_PAREN) : void 0) != null ? ref1 : null,
          consequent: (ref4 = (ref5 = this.block) != null ? ref5.ast(o, LEVEL_TOP).body : void 0) != null ? ref4 : [],
  ...
  exports.If = If = (function() {
    class If extends Base {
      ...
      astProperties(o) {
        var compiling, exeq, isStatement, properties, ref1, ref2;
        ({compiling} = o);
        ...
        properties = {
          test: this.useCondition(o).ast(o, isStatement ? LEVEL_PAREN : LEVEL_COND),
          consequent: isStatement ? this.body.ast(o, LEVEL_TOP) : this.bodyNode().ast(o, compiling ? LEVEL_LIST : LEVEL_TOP),
          alternate: this.isChain ? this.elseBody.unwrap().ast(o, isStatement ? LEVEL_TOP : LEVEL_COND) : !isStatement && ((ref1 = this.elseBody) != null ? (ref2 = ref1.expressions) != null ? ref2.length : void 0 : void 0) === 1 ? this.elseBody.expressions[0].ast(o, LEVEL_TOP) : this.elseBody != null ? this.elseBody.ast(o, LEVEL_TOP) : !isStatement && compiling ? new UndefinedLiteral().ast(o) : null
        };
        if (!compiling) {
