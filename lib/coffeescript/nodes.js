...
// multiline need to be indented.
  ...
  exports.Obj = Obj = (function() {
    class Obj extends Base {
      constructor(properties1 = [], {generated: generated = false} = {}) {
        super();
  ...
  exports.ExecutableClassBody = ExecutableClassBody = (function() {
    class ExecutableClassBody extends Base {
      ...
      _compileToBabylon(o) {
        var ident;
        this.name = this.class.name; // ? o.classScope.freeVariable @defaultClassVariableName
        ident = new IdentifierLiteral(this.name);
        this.walkBody();
        this.setContext();
        this.body.expressions.unshift(this.class);
        this.body.expressions.push(ident);
        return new Parens(new Call(new Value(new Code([], this.body), [new Access(new PropertyName('call'))]), [new ThisLiteral])).compileToBabylon(o);
      }
      ...
      expandThisParams(o) {
        ...
        this.eachParamName((name, node, param, obj) => {
          ...
          if (node.this) {
            ...
            replacement = param.withLocationData(param.name instanceof Obj && obj instanceof Assign && obj.operatorToken.value === '=' ? new Assign(new IdentifierLiteral(name), target, {
