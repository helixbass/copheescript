...
(function() {
  ...
  ({compact, flatten, extend, merge, del, starts, ends, some, addDataToNode, attachCommentsToNode, locationDataToString, throwSyntaxError, replaceUnicodeCodePointEscapes, locationDataToAst, astLocationFields, mergeAstLocationData, isFunction, isPlainObject, getNumberValue} = require('./helpers'));
