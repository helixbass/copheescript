...
// multiline need to be indented.
    ...
    class Range extends Base {
      ...
      compileVariablesForBabylon(o) {
        ...
        if (this.cachedToVarAssign === this.toVar) {
          return (this.cachedToVarAssign = null);
        }
      }
      ...
      compileForToBabylon(o) {
        ...
        known = this.from.isNumber() && this.to.isNumber() ? getNumberValue(this.from) <= getNumberValue(this.to) ? '<' : '>' : void 0;
        return {
          ...
          test: this.to.withLocationData(known ? new Op(`${known}${this.equals}`, indexVar, this.toVar) : new If(new Op(`<${this.equals}`, this.fromVar, this.toVar), new Op(`<${this.equals}`, indexVar, this.toVar)).addElse(new Op(`>${this.equals}`, indexVar, this.toVar))).compileToBabylon(o, LEVEL_PAREN),
          update: this.withLocationData(wrapInAssignToKeyVar(known ? new Op(known === '<' ? '++' : '--', indexVar, null, !named) : new If(new Op(`<${this.equals}`, this.fromVar, this.toVar), new Op('++', indexVar, null, !named)).addElse(new Op('--', indexVar, null, !named)))).compileToBabylon(o, LEVEL_PAREN)
        };
      }
  ...
  utilityBabylon = function(name, o) {
    ...
    return new Call(new Value(ref, [new Access(new PropertyName('call'))]), calledWithArgs);
  };
