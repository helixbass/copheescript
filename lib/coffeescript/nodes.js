...
// multiline need to be indented.
  ...
  exports.Value = Value = (function() {
    class Value extends Base {
      ...
      _compileToBabylon(o) {
        if (!this.properties.length) {
          return this.base.compileToBabylon(o);
        }
        return {
          type: 'MemberExpression',
          object: this.base.compileToBabylon(o),
          property: this.properties[0].compileToBabylon(o),
          computed: this.properties[0] instanceof Index
        };
      }
          ...
          results.push((function() {
            ...
            if (prop.shouldCache()) {
              ...
              if (prop.base.value.shouldCache()) {
                ...
                return new Assign(key, prop.base.value, 'object');
              }
    ...
    class If extends Base {
      ...
      compileExpressionToBabylon(o) {
        return {
          ...
          alternate: this.elseBodyNode() ? this.elseBodyNode().compileToBabylon(o, LEVEL_LIST) : {
