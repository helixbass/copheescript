...
// multiline need to be indented.
  ...
  exports.Call = Call = (function() {
    class Call extends Base {
      ...
      CSXToAst(o) {
        var attr, attrProps, attributes, base1, closingElement, closingElementBabylonLocationData, compiled, content, currentExpr, obj, openingElement, prop, rangeDiff, shiftAstLocationData, tagName;
        ...
        return {
          ...((function() {
            ...
            if (!tagName.value.length) {
              ...
              if (content) {
                closingElementBabylonLocationData = locationDataToAst(this.args.closingBracketLocationData);
                closingElement = this.withCopiedBabylonLocationData({
                  type: 'JSXClosingElement',
                  name: this.withCopiedBabylonLocationData(this.variable.unwrap().toAst(o), closingElementBabylonLocationData) //, LEVEL_ACCESS // TODO: this is inaccurate but not sure where to store the closing tagname location data
    ...
    class If extends Base {
      ...
      isStatement(o) {
        ...
        if (!o.compiling) {
          ...
          return this.bodyNode() instanceof Block || this.elseBodyNode() instanceof Block;
        }
