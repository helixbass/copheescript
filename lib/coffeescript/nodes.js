...
(function() {
  ...
  exports.Base = Base = (function() {
    class Base {
      ...
      compileClosureToBabylon(o) {
        ...
        return this.withLocationData(this.contains(isLiteralArguments) ? new Call(new Value(func, [new Access(new PropertyName('apply'))]), [new ThisLiteral, new IdentifierLiteral('arguments')]) : new Call(func, [])).compileToBabylon(o);
      }
  ...
  exports.PassthroughLiteral = PassthroughLiteral = class PassthroughLiteral extends Literal {
    _compileToBabylon(o) {
      ...
      return new IdentifierLiteral(this.value).compileToBabylon(o);
    }
...
// multiline need to be indented.
  ...
  exports.Range = Range = (function() {
    class Range extends Base {
      ...
      compileForToBabylon(o) {
        ...
        known = this.stepNum != null ? this.stepNum > 0 ? '<' : '>' : (this.fromNum != null) && (this.toNum != null) ? this.fromNum <= this.toNum ? '<' : '>' : void 0;
        [cachedFromVarAssign, fromVar] = this.from.cache(o, null, shouldCache);
        [cachedToVarAssign, toVar] = this.to.cache(o, null, shouldCache);
        if (cachedToVarAssign === toVar) {
          cachedToVarAssign = null;
        }
        if (this.step) {
          [cachedStepVarAssign, stepVar] = this.step.cache(o, null, shouldCache);
          ...
          properties: (function() {
            ...
            for (j = 0, len1 = ref1.length; j < len1; j++) {
              ...
              results.push(prop.withBabylonLocationData({
                type: 'ObjectProperty',
                key: compiledKey,
                value: prop instanceof Assign && prop.context !== 'object' ? {
  ...
  exports.Code = Code = (function() {
    class Code extends Base {
      ...
      processParams(o) {
        var exprs, name, param, params, value;
        exprs = [];
        params = (function() {
          var j, len1, ref1, results;
          ref1 = this.params;
          ...
          for (j = 0, len1 = ref1.length; j < len1; j++) {
            param = ref1[j];
            ({name, value} = param);
            if (name instanceof Arr || param.name instanceof Obj) {
            ...
            if (value) {
              results.push(new Assign(new Value(name), value, null, {
                param: true
              }));
            } else {
              results.push(param);
      ...
      _compileToBabylon(o) {
        var exprs, params, thisAssignments, wasEmpty;
        ...
        ({params, exprs} = this.processParams(o));
        ...
        return _extends1({
          ...
          async: this.isAsync,
          params: this.compileParamsToBabylon(params, o),
