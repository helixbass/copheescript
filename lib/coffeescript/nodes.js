...
(function() {
    ...
    class Base {
      ...
      ast(o, level) {
        ...
        return Object.assign({}, {
          type: this.astType(o)
        }, this.astReturns(o), this.astProperties(o, level), this.astLocationData());
      }
  ...
  exports.StringLiteral = StringLiteral = class StringLiteral extends Literal {
    ...
    ast(o, level) {
      if (this.shouldGenerateTemplateLiteral()) {
        return StringWithInterpolations.fromStringLiteral(this).ast(o, level);
      }
      return super.ast(o, level);
    }
  ...
  exports.Value = Value = (function() {
    class Value extends Base {
      ...
      ast(o, level) {
        ...
        if (!this.hasProperties()) {
          baseAst = this.base.ast(o, level);
          if (baseAst) {
            Object.assign(baseAst, this.astReturns(o));
          }
          return baseAst;
        }
  ...
  exports.JSXAttributes = JSXAttributes = (function() {
    class JSXAttributes extends Base {
      ...
      ast(o, level) {
        ...
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          attribute = ref1[j];
          results1.push(attribute.ast(o, level));
        }
        return results1;
      }
  ...
  exports.ImportClause = ImportClause = (function() {
    class ImportClause extends Base {
      ...
      ast(o, level) {
        ...
        return compact(flatten([(ref1 = this.defaultBinding) != null ? ref1.ast(o, level) : void 0, (ref2 = this.namedImports) != null ? ref2.ast(o, level) : void 0]));
      }
  ...
  exports.ModuleSpecifierList = ModuleSpecifierList = (function() {
    class ModuleSpecifierList extends Base {
      ...
      ast(o, level) {
        ...
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          specifier = ref1[j];
          results1.push(specifier.ast(o, level));
        }
        return results1;
      }
