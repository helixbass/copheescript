  ...
  exports.Block = Block = (function() {
    class Block extends Base {
      ...
      _compileToBabylon(o) {
        ...
        return this.includeCommentsInLocationData(Object.assign({
          type: this.astType()
        }, {body, directives: this.directives}, this.astLocationData()));
      }
...
// multiline need to be indented.
  ...
  exports.Call = Call = (function() {
    class Call extends Base {
      ...
      compileCSX(o) {
        var attr, attributes, content, fragments, j, len1, obj, ref1, tag;
        ...
        if (attributes.base instanceof Arr) {
          ...
          for (j = 0, len1 = ref1.length; j < len1; j++) {
            obj = ref1[j];
            this.checkValidCSXAttribute(obj);
            attr = obj.base;
      ...
      getCSXAttributeAst(object, o) {
        var ast, attribute;
        this.checkValidCSXAttribute(object);
        ({
          base: attribute
        } = object);
        attribute.csx = true;
      ...
      CSXElementToAst({o, tagName, attributes, openingElementLocationData, closingElementLocationData}) {
        ...
        openingElement = Object.assign({
          ...
          selfClosing: closingElementLocationData == null,
          attributes: flatten((function() {
            ...
            for (j = 0, len1 = ref1.length; j < len1; j++) {
              object = ref1[j];
              results.push(this.getCSXAttributeAst(object, o));
            }
            return results;
          }).call(this))
        }, openingElementLocationData);
        closingElement = null;
        if (closingElementLocationData != null) {
      ...
      CSXToAst(o) {
        var attributes, base1, closingElementLocationData, content, openingElementLocationData, tagName;
        [attributes, content] = this.args;
        ...
        if (tagName.closingTagOpeningBracketLocationData != null) {
        ...
        return Object.assign(tagName.value.length ? this.CSXElementToAst({o, tagName, attributes, openingElementLocationData, closingElementLocationData}) : this.CSXFragmentToAst({o, openingElementLocationData, closingElementLocationData}), {
      ...
      CSXAttributesToAst(o) {
        ...
        propertiesAst = (function() {
          ...
          for (j = 0, len1 = ref1.length; j < len1; j++) {
            property = ref1[j];
            property.csx = true;
            results.push(property.ast(o)); //, LEVEL_TOP
          }
          return results;
        }).call(this);
    ...
    class Assign extends Base {
      ...
      CSXAttributeToAst(o) {
        return Object.assign({
          ...
          value: this.getCSXAttributeValueAst(o)
        }, this.astLocationData());
      }
        ...
        params = compact((function() {
          ...
          for (j = 0, len1 = ref1.length; j < len1; j++) {
            ...
            if (splat || param instanceof Expansion) {
              ...
              }).withLocationDataFrom(param) : asRef, name instanceof Arr || name instanceof Obj ? !param.shouldCache() ? name.eachName(function({value}) {
