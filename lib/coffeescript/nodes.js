  ...
  exports.Base = Base = (function() {
    class Base {
      ...
      withBabylonComments(o, compiled) {
        var comment, comments, compiledComment, last, leading, rest, start;
        if (!this.comments) {
          return compiled;
        }
    ...
    class Block extends Base {
      ...
      hoistBabylonComments(compiled, {onlyTrailing, onlyLeading} = {}) {
        ...
        traverseBabylonAst(compiled, (node, {parent, key}) => {
          var comment, leading, nonmatching, ref3, ref4, ref5;
          ...
          if (onlyTrailing || onlyLeading) {
            // dump 'hoisting comments', {compiled, targetNode, node, comments}
            nonmatching = [];
          }
          comments.push(...compact((function() {
            var j, len1, ref6, results;
            ref6 = node.comments;
            results = [];
            for (j = 0, len1 = ref6.length; j < len1; j++) {
              comment = ref6[j];
              leading = comment.end <= targetNode.start || isDummyLocationData;
              if (onlyTrailing && leading || onlyLeading && !leading) {
...
// multiline need to be indented.
  ...
  exports.Super = Super = (function() {
    class Super extends Base {
      ...
      _compileToBabylon(o) {
        ...
        compiled = new Value(new SuperLiteral, this.accessor ? [this.accessor] : []).compileToBabylon(o);
        if (salvagedComments) {
  ...
  exports.Class = Class = (function() {
    class Class extends Base {
      ...
      compileClassDeclarationToBabylon(o) {
        ...
        if (this.name) {
          id = new IdentifierLiteral(this.name);
        }
  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      ...
      _compileToBabylon(o) {
        var compiledValue, compiledVariable, ref1, ref2;
        if (this.csx) {
        ...
        compiledValue = this.value.compileToBabylon(o, LEVEL_LIST);
        compiledVariable = this.variable.compileToBabylon(o, LEVEL_LIST);
        return {
