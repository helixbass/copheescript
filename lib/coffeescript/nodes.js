...
// multiline need to be indented.
  ...
  exports.Call = Call = (function() {
    class Call extends Base {
      ...
      CSXToAst(o) {
        var attr, attrProps, attributes, base1, closingElement, closingElementBabylonLocationData, compiled, content, obj, openingElement, tagName;
        ...
        return {
          ...
          })()), content ? (closingElementBabylonLocationData = locationDataToAst(this.args.closingBracketLocationData), closingElement = this.withCopiedBabylonLocationData({
            type: 'JSXClosingElement',
            name: this.withCopiedBabylonLocationData(tagName.toAst(o), closingElementBabylonLocationData) // TODO: this is inaccurate but not sure where to store the closing tagname location data
          }, closingElementBabylonLocationData)) : void 0, {
            type: 'JSXElement',
            openingElement,
            closingElement
          })),
