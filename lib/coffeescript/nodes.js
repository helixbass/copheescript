    ...
    class Value extends Base {
      ...
      _toAst(o) {
        ...
        for (propIndex = j = 0, len1 = props.length; j < len1; propIndex = ++j) {
          ...
          ret = prop instanceof Slice && o.compiling ? prop.compileValueToBabylon(o, ret) : mergeBabylonLocationData(prop.withAstLocationData({
          ...
          if (this.base instanceof Parens && (this.base.locationData != null) && propIndex === 0) {
            mergeBabylonLocationData(ret, locationDataToAst(this.base.locationData));
          }
        }
        return ret;
      }
