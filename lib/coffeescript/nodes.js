  ...
  exports.Base = Base = (function() {
    class Base {
      ...
      withBabylonComments(o, compiled) {
        var comment, comments, last, rest;
        if (!this.comments) {
          return compiled;
        }
        comments = compact((function() {
          var j, len1, ref1, results;
          ref1 = this.comments;
          results = [];
          for (j = 0, len1 = ref1.length; j < len1; j++) {
            comment = ref1[j];
            if (!(indexOf.call(this.compiledBabylonComments, comment) < 0)) {
              continue;
            }
  ...
  exports.Block = Block = (function() {
    class Block extends Base {
      ...
      compileRootToBabylon(o) {
        var comments, compiledBody, program, programComments;
        // @spaced   = yes
      ...
      hoistBabylonComments(compiled) {
        var comment, comments, ref1, ref2, targetNode, trailing;
        ...
        traverseBabylonAst(compiled, (node) => {
          var ref3, ref4;
          if (ref3 = node.type, indexOf.call(BABYLON_STATEMENT_TYPES, ref3) >= 0) {
            this.hoistBabylonComments(node);
            return 'STOP';
          }
          if (!((ref4 = node.comments) != null ? ref4.length : void 0)) {
            return ((node.start != null) && (node.type == null) ? 'REMOVE' : void 0);
          }
