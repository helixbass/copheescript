...
(function() {
  ...
  ({compact, flatten, extend, merge, del, starts, ends, some, addDataToNode, attachCommentsToNode, locationDataToString, throwSyntaxError, replaceUnicodeCodePointEscapes, locationDataToBabylon, babylonLocationFields, isArray, isFunction, isPlainObject, isBoolean, getNumberValue, dump, mapValues, traverseBabylonAst, makeDelimitedLiteral, mergeBabylonLocationData, mergeLocationData, assignEmptyTrailingLocationData} = require('./helpers'));
    ...
    class Value extends Base {
      ...
      _toAst(o) {
        ...
        for (propIndex = j = 0, len1 = props.length; j < len1; propIndex = ++j) {
          ...
          ret = prop instanceof Slice && o.compiling ? prop.compileValueToBabylon(o, ret) : mergeBabylonLocationData(prop.withBabylonLocationData({
          ...
          if (this.base instanceof Parens && (this.base.locationData != null) && propIndex === 0) {
            mergeBabylonLocationData(ret, locationDataToBabylon(this.base.locationData));
          }
        }
        return ret;
      }
    ...
    class Call extends Base {
      ...
      CSXToAst(o) {
        ...
        return {
          ...
          } : (openingElement = tagName.withBabylonLocationData({
            ...
            if (attributes.base instanceof Arr) {
              ...
              for (j = 0, len1 = ref1.length; j < len1; j++) {
                ...
                if (attr instanceof IdentifierLiteral) {
                  results.push(attr.withBabylonLocationData({
                    type: 'JSXAttribute',
                    name: compiled
                  }));
                } else {
          ...
          })()), content ? (closingElementBabylonLocationData = locationDataToBabylon(this.args.closingBracketLocationData), closingElement = this.withCopiedBabylonLocationData({
      ...
      CSXAttributeToAst(o) {
        return {
          ...
          value: (() => {
            ...
            return val.withBabylonLocationData({
          ...
          cases: [
            ...
            results1;
                  ...
                  for (testIndex = k = 0, len2 = tests.length; k < len2; testIndex = ++k) {
                    ...
                    compiledCase = test.withBabylonLocationData((() => {
                      if ((() => {
                        var lastExpr;
                        if (!compiling) {
                          return false;
            ...
            ...(((ref3 = this.otherwise) != null ? ref3.expressions.length : void 0) ? [
              this.otherwise.withBabylonLocationData({
                type: 'SwitchCase',
                test: null,
