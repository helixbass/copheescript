  ...
  exports.Block = Block = (function() {
    class Block extends Base {
      ...
      compileWithDeclarationsToBabylon(o) {
        ...
        compiledBody = this.compileBodyToBabylon(o);
        return [...this.compileDeclarationsToBabylon(o), ...compiledBody];
      }
    ...
    class Assign extends Base {
      ...
      compileToBabylon(o) {
        ...
        return {
          ...
          operator: '=',
          left: this.variable.compileToBabylon(o),
          right: this.value.compileToBabylon(o)
        };
      }
