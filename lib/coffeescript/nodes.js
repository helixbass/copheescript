  ...
  exports.Base = Base = (function() {
    class Base {
      ...
      compileClosureToBabylon(o) {
        ...
        return this.withLocationData(wrapInAwait(this.contains(isLiteralArguments) ? new Call(new Value(func, [new Access(new PropertyName('apply'))]), [new ThisLiteral, new IdentifierLiteral('arguments')]) : this.contains(isLiteralThis) ? new Call(new Value(func, [new Access(new PropertyName('call'))]), [new ThisLiteral]) : new Call(func, []))).compileToBabylon(o);
      }
...
// multiline need to be indented.
  ...
  exports.SuperCall = SuperCall = (function() {
    class SuperCall extends Call {
      ...
      _compileToBabylon(o) {
        ...
        return new Block([this, ...this.expressions]).compileToBabylon(o, o.level === LEVEL_TOP ? o.level : LEVEL_LIST);
      }
  ...
  exports.Code = Code = (function() {
    class Code extends Base {
      ...
      compileParamsToBabylon({params, haveSplatParam, o}) {
        var compiled, generatedVariables, index, j, lastIndex, len1, param, results, scopeVariablesCount;
        ...
        params = compact((function() {
          ...
          for (j = 0, len1 = ref1.length; j < len1; j++) {
            ...
            if (splat || param instanceof Expansion) {
              ...
              }) : asRef, name instanceof Arr || name instanceof Obj ? (name.lhs = true, !param.shouldCache() ? name.eachName(function({value}) {
      ...
      _compileToBabylon(o) {
        ...
        if (this.isMethod && this.bound && !this.isStatic && this.classVariable) {
          this.body.expressions.unshift(utilityBabylon('boundMethodCheck', merge(o, {
  ...
  exports.Sequence = Sequence = (function() {
    class Sequence extends Base {
      ...
      _compileToBabylon(o) {
        var expression;
        if (this.expressions.length === 1) {
          return this.expressions[0].compileToBabylon(o);
        }
        return {
      ...
      compileStatementToBabylon(o) {
        ...
        return {
          ...
          alternate: (() => {
            ...
            compiled = this.elseBody.compileToBabylon(o, LEVEL_TOP);
  ...
  utilityBabylon = function(name, o) {
    ...
    return new Call(new Value(ref, invokedWithArgs ? [] : [new Access(new PropertyName(calledWithArgs ? 'call' : 'apply'))]), (ref1 = calledWithArgs != null ? calledWithArgs : appliedWithArgs) != null ? ref1 : invokedWithArgs);
  };
