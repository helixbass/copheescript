...
// multiline need to be indented.
  ...
  exports.Obj = Obj = (function() {
    class Obj extends Base {
      ...
      _compileToBabylon(o) {
        if (this.jsx) {
          return this.JSXAttributesToAst(o);
        }
      ...
      compileNode(o) {
        ...
        if (this.jsx) {
          ...
          return this.compileJSXAttributes(o);
        }
        if (this.hasSplat() && this.lhs) {
          this.reorderProperties();
        }
  ...
  exports.ObjectProperty = ObjectProperty = class ObjectProperty extends Base {
    ...
    astProperties(o) {
      ...
      return {
        ...
        //   else
        //     @key.ast o
        key: this.key.ast(o, LEVEL_LIST),
        value: (ref1 = (ref2 = this.value) != null ? ref2.ast(o, LEVEL_LIST) : void 0) != null ? ref1 : this.key.ast(o, LEVEL_LIST),
  ...
  exports.ClassProperty = ClassProperty = (function() {
    ...
    ClassProperty.prototype.isStatementAst = YES;
  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      ...
      _compileToBabylon(o) {
        var ref1, ref2;
        if (this.jsx) {
          return this.JSXAttributeToAst(o);
        }
      ...
      JSXAttributeToAst(o) {
        return Object.assign({
          ...
          value: this.getJSXAttributeValueAst(o)
    ...
    class StringWithInterpolations extends Base {
      ...
      extractElements(o, {includeInterpolationWrappers, isJsx} = {}) {
        ...
        expr.traverseChildren(false, (node) => {
          var comment, commentPlaceholder, empty, isEmpty, j, k, len1, len2, ref1, ref2, ref3, ref4, unwrapped;
          if (node instanceof StringLiteral) {
            ...
            if (isEmpty && !isJsx) {
              ...
              if ((ref3 = node.expression) != null) {
                ref3.locationData = node.locationData;
              }
