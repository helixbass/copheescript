...
(function() {
  ...
  ({compact, flatten, extend, merge, del, starts, ends, some, addDataToNode, attachCommentsToNode, locationDataToString, throwSyntaxError, replaceUnicodeCodePointEscapes, locationDataToAst, astLocationFields, mergeAstLocationData, isFunction, isPlainObject, isBoolean, getNumberValue, dump, mapValues, traverseBabylonAst, makeDelimitedLiteral, mergeLocationData, assignEmptyTrailingLocationData, UNICODE_CODE_POINT_ESCAPE} = require('./helpers'));
...
// compact(
      ...
      mergeLocationDataFrom(node) {
        return mergeLocationData(this, node);
      }
      ...
      toAst(o, level) {
        ...
        return this.withAstLocationData(this.withAstReturns(this.withAstType(this._toAst(o), o)));
      }
      ...
      getAstChildren(o) {
        var addChildAst, childAsts, children, defaultVal, j, key, len1, level, propName, ref1;
  ...
  exports.Block = Block = (function() {
    class Block extends Base {
      ...
      rootToAst(o) {
        var body, comment, comments, j, len1, program;
        this.initializeScope(o);
        ...
        program = this.withAstLocationData({
          type: 'Program',
          sourceType: 'module',
          body,
          directives: this.directives
        ...
        for (j = 0, len1 = comments.length; j < len1; j++) {
          comment = comments[j];
          mergeAstLocationData(program, comment);
        }
        return this.withCopiedBabylonLocationData({
          type: 'File',
          program,
  ...
  exports.StringLiteral = StringLiteral = class StringLiteral extends Literal {
    ...
    _toAst(o) {
      ...
      if (!o.compiling && this.quote.length === 3 && this.originalValue.indexOf('\n') > -1) {
        return StringWithInterpolations.fromStringLiteral(this).toAst(o);
      }
      return super._toAst(o);
    }
  ...
  exports.CSXTag = CSXTag = (function() {
    ...
    CSXTag.prototype.astType = 'JSXIdentifier';

    CSXTag.prototype.astProps = {
      name: 'value'
    };
...
// multiline need to be indented.
  ...
  exports.YieldReturn = YieldReturn = class YieldReturn extends Return {
    ...
    toAst(o, level) {
      ...
      return new Op('yield', new Return(this.expression)).withLocationDataFrom(this).toAst(o, level);
    }
  ...
  exports.AwaitReturn = AwaitReturn = class AwaitReturn extends Return {
    ...
    toAst(o, level) {
      ...
      return new Op('await', new Return(this.expression)).withLocationDataFrom(this).toAst(o, level);
    }
  ...
  exports.Value = Value = (function() {
    class Value extends Base {
      ...
      _toAst(o) {
        var isCsx, j, len1, prop, propIndex, props, ref1, ret;
        props = this.properties;
        ret = this.base.toAst(o, props.length ? LEVEL_ACCESS : null);
        isCsx = this.base instanceof CSXTag;
        for (propIndex = j = 0, len1 = props.length; j < len1; propIndex = ++j) {
          prop = props[propIndex];
          if (isCsx) {
            prop.name.csx = true;
          }
          ret = prop instanceof Slice && o.compiling ? prop.compileValueToBabylon(o, ret) : mergeAstLocationData(prop.withAstLocationData({
            type: isCsx ? 'JSXMemberExpression' : 'MemberExpression',
            object: ret,
          ...
          if (propIndex === 0 && this.base instanceof Parens && (this.base.locationData != null)) {
            mergeAstLocationData(ret, locationDataToAst(this.base.locationData));
          }
        }
        return ret;
      }
  ...
  exports.Call = Call = (function() {
    class Call extends Base {
      ...
      CSXToAst(o) {
        var attr, attrProps, attributes, base1, closingElement, closingFragment, closingTagNameAstLocationData, compiled, content, currentExpr, obj, openingElement, openingFragment, prop, rangeDiff, shiftAstLocationData, tagName;
        ...
        return {
          ...((function() {
            ...
            if (!tagName.value.length) {
              ...
              closingFragment = this.withCopiedBabylonLocationData({
              ...
              openingElement = tagName.withAstLocationData({
                type: 'JSXOpeningElement',
                name: this.variable.unwrap().toAst(o), //, LEVEL_ACCESS
                selfClosing: !content
              });
              ...
              openingElement.attributes = flatten((function() {
                ...
                if (attributes.base instanceof Arr) {
                  ...
                  for (k = 0, len2 = ref2.length; k < len2; k++) {
                    ...
                    if (attr instanceof IdentifierLiteral) {
                      results.push(attr.withAstLocationData({
                        type: 'JSXAttribute',
                        name: compiled,
                        value: null
                      }));
              ...
              if (content) {
                ...
                closingElement = this.withCopiedBabylonLocationData({
                  type: 'JSXClosingElement',
                  name: this.withCopiedBabylonLocationData(this.variable.unwrap().toAst(o), closingTagNameAstLocationData) //, LEVEL_ACCESS
  ...
  exports.RegexWithInterpolations = RegexWithInterpolations = (function() {
    class RegexWithInterpolations extends Base {
      ...
      astChildren(o) {
        return {
          interpolatedPattern: this.call.args[0].toAst(o)
        };
      }
    ...
    RegexWithInterpolations.prototype.astType = 'InterpolatedRegExpLiteral';
  ...
  exports.ClassProperty = ClassProperty = (function() {
    class ClassProperty extends Base {
      ...
      astProps() {
        ...
        if ((ref3 = this.isStatic) != null ? ref3.className : void 0) {
    ...
    ClassProperty.prototype.astChildren = {
      key: 'name',
      value: 'value'
    };
  ...
  exports.Op = Op = (function() {
    ...
    class Op extends Base {
      ...
      astProps(o) {
        ...
        switch (false) {
          case !(this.operator === 'new' || this.isAwait()):
            return {};
          case !this.isYield():
            return {
      ...
      _toAst(o) {
        ...
        return {
          ...
          handler: compiling ? placeholder ? (this.recovery || this).withAstLocationData({
            ...
            type: 'CatchClause',
            param: (ref2 = (ref3 = this.errorVariable) != null ? ref3.toAst(o) : void 0) != null ? ref2 : null,
            body: this.recovery.toAst(o, LEVEL_TOP)
          }) : void 0,
          finalizer: (ref4 = this.ensure) != null ? ref4.toAst(o, LEVEL_TOP) : void 0
        };
      }
  ...
  exports.Interpolation = Interpolation = (function() {
    class Interpolation extends Base {
      ...
      _toAst(o) {
        if (this.expression) {
          this.error('Interpolation::toAst() should only be called for empty interpolations');
        }
        return super._toAst(o);
      }
    ...
    Interpolation.prototype.astChildren = [];

    Interpolation.prototype.emptyAst = true;
  ...
  exports.Switch = Switch = (function() {
    class Switch extends Base {
      ...
      astChildren(o) {
        var caseIndex, compiledCase, compiling, consequent, kase, lastCaseIndex, lastTestIndex, leadingToken, ref1, ref2, ref3, test, testIndex, tests, trailingToken;
        ({compiling} = o);
          ...
          cases: [
            ...
            results1;
                  ...
                  for (testIndex = k = 0, len2 = tests.length; k < len2; testIndex = ++k) {
                    ...
                    compiledCase = test.withAstLocationData((() => {
                      if ((() => {
                        var lastExpr;
                        if (!compiling) {
                          return false;
            ...
            LEVEL_TOP).body : [],
                    ...
                    if (compiledCase.consequent.length) {
                      mergeAstLocationData(compiledCase,
            compiledCase.consequent[compiledCase.consequent.length - 1]);
                    }
                    if (testIndex === 0) {
                      mergeAstLocationData(compiledCase,
    ...
    class If extends Base {
      ...
      statementToAst(o) {
        ...
        return {
          ...
          consequent: this.ensureBlock(this.body).toAst(o, LEVEL_TOP),
          alternate: (() => {
            var compiled;
            if (!this.elseBody) {
              return;
  ...
  astAsBlock = function(element, o) {
    ...
    if (!o.compiling && unwrapped instanceof Block && unwrapped.expressions.length > 1) {
      return unwrapped.toAst(o, LEVEL_TOP);
    } else {
      return element.toAst(o, LEVEL_PAREN);
    }
  };
