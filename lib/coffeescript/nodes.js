...
(function() {
  ...
  var Access, Arr, Assign, AwaitReturn, Base, Block, BooleanLiteral, CSXTag, Call, Class, Code, CodeFragment, ComputedPropertyName, Elision, ExecutableClassBody, Existence, Expansion, ExportAllDeclaration, ExportDeclaration, ExportDefaultDeclaration, ExportNamedDeclaration, ExportSpecifier, ExportSpecifierList, Extends, For, FuncGlyph, HereComment, HoistTarget, IdentifierLiteral, If, ImportClause, ImportDeclaration, ImportDefaultSpecifier, ImportNamespaceSpecifier, ImportSpecifier, ImportSpecifierList, In, Index, InfinityLiteral, JS_FORBIDDEN, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, LineComment, Literal, ModuleDeclaration, ModuleSpecifier, ModuleSpecifierList, NEGATE, NO, NaNLiteral, NullLiteral, NumberLiteral, Obj, Op, Param, Parens, PassthroughLiteral, PropertyName, Range, RegexLiteral, RegexWithInterpolations, Return, SIMPLENUM, Scope, Sequence, Slice, Splat, StatementLiteral, StringLiteral, StringWithInterpolations, Super, SuperCall, Switch, TAB, THIS, TaggedTemplateCall, ThisLiteral, Throw, Try, UTILITIES, UTILITIES_BABYLON, UndefinedLiteral, Value, While, YES, YieldReturn, addDataToNode, attachCommentsToNode, compact, del, dump, ends, extend, flatten, fragmentsToText, getNumberValue, hasLineComments, indentInitial, isArray, isLiteralArguments, isLiteralThis, isUnassignable, locationDataToBabylon, locationDataToString, merge, moveComments, multident, prettier, shouldCacheOrIsAssignable, some, starts, throwSyntaxError, unfoldSoak, unshiftAfterComments, utility, utilityBabylon,
    indexOf = [].indexOf,
    splice = [].splice,
    slice1 = [].slice,
  ...
  ({compact, flatten, extend, merge, del, starts, ends, some, addDataToNode, attachCommentsToNode, locationDataToString, throwSyntaxError, getNumberValue, dump, locationDataToBabylon, isArray} = require('./helpers'));
  ...
  exports.Base = Base = (function() {
    class Base {
      ...
      compileClosureToBabylon(o) {
        o.sharedScope = true;
        return this.withLocationData(new Call(new Code([], Block.wrap([this])), [])).compileToBabylon(o);
      }
  ...
  exports.Block = Block = (function() {
    class Block extends Base {
      ...
      prettier(o) {
        ...
        return prettier.__debug.formatAST(ast, opts).formatted;
      }
      ...
      compileRootToBabylon(o) {
        ...
        return this.withBabylonLocationData({
          ...
          program: {
            type: 'Program',
            sourceType: 'module',
            body: this.compileWithDeclarationsToBabylon(merge(o, {
              root: true
            })),
            directives: []
          },
  ...
  exports.StringLiteral = StringLiteral = (function() {
    ...
    StringLiteral.prototype.babylonType = 'StringLiteral';
...
// multiline need to be indented.
  ...
  exports.Range = Range = (function() {
    class Range extends Base {
      ...
      compileVariablesForBabylon(o) {
        ...
        shouldCache = del(o, 'shouldCache');
        [this.cachedFromVarAssign, this.fromVar] = this.from.cache(o, null, shouldCache);
        [this.cachedToVarAssign, this.toVar] = this.to.cache(o, null, shouldCache);
        if (this.cachedToVarAssign === this.toVar) {
          this.cachedToVarAssign = null;
        }
        if (this.from.isNumber()) {
          this.fromNum = getNumberValue(this.from);
        }
        if (this.to.isNumber()) {
          return (this.toNum = getNumberValue(this.to));
        }
      }
      ...
      compileForToBabylon(o) {
        var indexVar, keyVar, known, named, wrapInAssignToKeyVar;
        ...
        known = (this.fromNum != null) && (this.toNum != null) ? this.fromNum <= this.toNum ? '<' : '>' : void 0;
        return {
          init: new Sequence([this.from.withLocationData(wrapInAssignToKeyVar(new Assign(indexVar, this.cachedFromVarAssign))), ...(this.cachedToVarAssign ? [this.cachedToVarAssign] : [])]).compileToBabylon(o),
          test: this.to.withLocationData(known ? new Op(`${known}${this.equals}`, indexVar, this.toVar) : new If(new Op('<=', this.fromVar, this.toVar), new Op(`<${this.equals}`, indexVar, this.toVar)).addElse(new Op(`>${this.equals}`, indexVar, this.toVar))).compileToBabylon(o, LEVEL_PAREN),
          update: this.withLocationData(wrapInAssignToKeyVar(known ? new Op(known === '<' ? '++' : '--', indexVar, null, !named) : new If(new Op('<=', this.fromVar, this.toVar), new Op('++', indexVar, null, !named)).addElse(new Op('--', indexVar, null, !named)))).compileToBabylon(o, LEVEL_PAREN)
        };
      }
    ...
    class Slice extends Base {
      ...
      compileValueToBabylon(o, compiledValue) {
        ...
        toNum = (function() {
          ...
          if (to instanceof Op) {
            return getNumberValue(to.first) * (to.operator === '-' ? -1 : 1);
          } else {
  ...
  exports.Obj = Obj = (function() {
    class Obj extends Base {
      ...
      _compileToBabylon(o) {
        var isComputedPropertyName, prop, shorthand, value, variable;
        return {
          ...
          properties: (function() {
            ...
            for (j = 0, len1 = ref1.length; j < len1; j++) {
              ...
              results.push(prop.withBabylonLocationData({
                type: 'ObjectProperty',
                key: (isComputedPropertyName ? variable.base.value : variable.unwrap()).compileToBabylon(o, LEVEL_LIST),
      ...
      expandProperties(o) {
        ...
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          ...
          results.push((function() {
            ...
            return prop.withLocationData(prop.shouldCache() ? ([key, value] = prop.base.cache(o), key instanceof IdentifierLiteral ? key = key.withLocationData(new PropertyName(key.value)) : void 0, new Assign(key, value, 'object')) : prop instanceof Value && prop.base instanceof ComputedPropertyName ? prop.base.value.shouldCache() ? ([key, value] = prop.base.value.cache(o), key instanceof IdentifierLiteral ? key = key.withLocationData(new Value(new ComputedPropertyName(key.value))) : void 0, new Assign(key, value, 'object')) : new Assign(prop.base.value.isNumber() || prop.base.value.isString() ? prop.base.value : prop, prop.base.value, 'object') : new Assign(prop, prop, 'object', {
    ...
    class Class extends Base {
      ...
      compileClassDeclarationToBabylon(o) {
        return {
          ...
          id: new IdentifierLiteral(this.name).compileToBabylon(o),
          superClass: null,
  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      constructor(variable1, value1, context1, {
          param: param1,
          subpattern,
          operatorToken,
          moduleDeclaration,
      ...
      compileDestructuringToBabylon(o) {
        var assigns, expans, expansIndex, getSlice, getSplice, i, isExpans, isSplat, leftObjs, obj, objects, processObjects, rightObjs, slicer, splats, splatsAndExpans, value;
        ({value} = this);
      ...
      compileConditionalToBabylon(o) {
        ...
        if (indexOf.call(this.context, "?") >= 0) {
          ...
          return new If(new Existence(left), right, {
            type: 'if'
          }).addElse(new Assign(right, this.value, '=')).compileToBabylon(o);
        } else {
          return this.wrapInParensIf(o.level <= LEVEL_LIST)(new Op(this.context.slice(0, -1), left, new Assign(right, this.value, '='))).compileToBabylon(o);
        }
      }
    ...
    class Code extends Base {
      ...
      compileParamsToBabylon(o) {
        ...
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          ...
          results.push(param.name.compileToBabylon(o));
        }
        return results;
      }

      _compileToBabylon(o) {
        var thisAssignments, wasEmpty;
        ...
        return _extends1({
          type: this.isMethod ? 'ClassMethod' : this.bound ? 'ArrowFunctionExpression' : 'FunctionExpression',
          generator: this.isGenerator,
          async: this.isAsync,
          params: this.compileParamsToBabylon(o),
      ...
      expandThisParams(o) {
        ...
        this.eachParamName((name, node, param, obj) => {
          ...
          if (node.this) {
            ...
            replacement = param.withLocationData(param.name instanceof Obj && obj instanceof Assign && obj.operatorToken.value === '=' ? new Assign(new IdentifierLiteral(name), target, 'object') : target); //, operatorToken: new Literal ':'
  ...
  exports.In = In = (function() {
    class In extends Base {
      ...
      compileLoopTestToBabylon(o) {
        return this.wrapInParensIf(o.level < LEVEL_LIST)(new Op('>=', utilityBabylon('indexOf', merge(o, {
          calledWithArgs: [this.array, this.object]
        })), new NumberLiteral('0'))).compileToBabylon(o);
      }
    ...
    class For extends While {
      ...
      _compileToBabylon(o) {
        ...
        if (!this.range) {
          ...
          if (name && !this.from) {
            this.body.expressions.unshift(this.withLocationData(new Assign(name, new Value(name.withLocationData(new IdentifierLiteral(sourceVar.unwrap().value)), [new Index(keyVar)]))));
          }
        }
        ...
        if (this.step && !this.range) {
          [cachedStepVarAssign, stepVar] = this.step.cache(o, null, shouldCacheOrIsAssignable);
          if (cachedStepVarAssign === stepVar) {
            cachedStepVarAssign = null;
          }
        }
      ...
      compileForPartsToBabylon({o, keyVar, indexVar, sourceVar, stepVar}) {
        var lengthVar, shouldWrapInAssignToKeyVar, wrapInAssignToKeyVar;
        ...
        return {
          init: indexVar.withLocationData(new Sequence([wrapInAssignToKeyVar(new Assign(indexVar, new NumberLiteral('0'))), new Assign(lengthVar, new Value(this.withLocationData(new IdentifierLiteral(sourceVar.unwrap().value)), [new Access(new PropertyName('length'))]))])).compileToBabylon(o),
          test: this.withLocationData(new Op('<', indexVar, lengthVar)).compileToBabylon(o),
          update: this.withLocationData(wrapInAssignToKeyVar(this.step ? new Op('+=', indexVar, stepVar) : new Op('++', indexVar, null, !shouldWrapInAssignToKeyVar))).compileToBabylon(o)
        };
      }
