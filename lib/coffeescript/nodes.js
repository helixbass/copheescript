  ...
  exports.Call = Call = (function() {
    class Call extends Base {
      ...
      CSXElementToAst({o, tagName, attributes, content}) {
        var attr, attrProps, attributesAst, closingElement, closingElementLocationData, compiled, compiledAttr, currentExpr, obj, openingElement, openingElementLocationData, rangeDiff, shiftAstLocationData;
        ...
        if (content) {
          ...
          closingElement = Object.assign({
            ...
            name: Object.assign(this.variable.unwrap().ast(o), locationDataToAst(tagName.closingTagNameLocationData)) //, LEVEL_ACCESS
      ...
      CSXToAst(o) {
        var attributes, base1, closingFragment, closingFragmentLocationData, content, openingFragment, openingFragmentLocationData, tagName;
        [attributes, content] = this.args;
        tagName = this.variable.base;
        tagName.locationData = tagName.tagNameLocationData;
        return {
          ...(!tagName.value.length ? (openingFragmentLocationData = tagName.astLocationData(), attributes.base instanceof Arr ? openingFragmentLocationData = mergeAstLocationData(openingFragmentLocationData, locationDataToAst(attributes.base.locationData)) : void 0, openingFragment = Object.assign({
            type: 'JSXOpeningFragment'
          }, openingFragmentLocationData), closingFragmentLocationData = mergeAstLocationData(locationDataToAst(tagName.closingTagOpeningBracketLocationData), locationDataToAst(tagName.closingTagClosingBracketLocationData)), closingFragment = Object.assign({
            type: 'JSXClosingFragment'
          }, closingFragmentLocationData), Object.assign({
            type: 'JSXFragment',
            openingFragment,
            closingFragment
          }, mergeAstLocationData(openingFragmentLocationData, closingFragmentLocationData), this.astReturns())) : this.CSXElementToAst({o, tagName, attributes, content})),
      ...
      CSXToAst(o) {
        ...
        return Object.assign(this.CSXElementToAst({o, tagName, attributes, content}), {
          // else
