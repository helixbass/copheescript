...
// compact(
      ...
      mergeLocationDataFrom(node) {
        return this.locationData = this.locationData == null ? node.locationData : mergeLocationData(this.locationData, node.locationData);
      }
    ...
    class Block extends Base {
      ...
      ast(o, level) {
        ...
        if (o.level !== LEVEL_TOP && this.expressions.length) {
          ...
          return (new Sequence(this.expressions)).ast(o);
        }
...
// multiline need to be indented.
      ...
      astProperties(o) {
        return {
          argument: this.expression.ast(o, LEVEL_PAREN)
        };
      }
  ...
  exports.Call = Call = (function() {
    class Call extends Base {
      ...
      CSXToAst(o) {
        var attr, attrProps, attributes, attributesAst, base1, closingElement, closingElementLocationData, closingFragment, closingFragmentLocationData, compiled, content, currentExpr, obj, openingElement, openingElementLocationData, openingFragment, openingFragmentLocationData, prop, rangeDiff, shiftAstLocationData, tagName;
            ...
            if (!tagName.value.length) {
              ...
              if (content) {
                ...
                closingElement = Object.assign({
                  ...
                  name: this.withCopiedBabylonLocationData(this.variable.unwrap().ast(o), closingTagNameAstLocationData) //, LEVEL_ACCESS
  ...
  exports.Arr = Arr = (function() {
    class Arr extends Base {
      ...
      astProperties(o) {
        return {
          elements: this.objects.ast(o, LEVEL_LIST)
        };
      }
  ...
  exports.Class = Class = (function() {
    class Class extends Base {
      ...
      astProperties(o) {
        return {
          id: this.variable.ast(o),
          superClass: this.parent.ast(o, LEVEL_PAREN),
