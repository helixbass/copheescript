...
// compact(
      ...
      sniffDirectives(expressions, {replace, notFinalExpression} = {}) {
        ...
        while (expr = expressions[index]) {
          ...
          if (!(expr instanceof Value && expr.isString() && !expr.unwrap().shouldGenerateTemplateLiteralAst())) {
            break;
          }
          if (expr.hoisted) {
            index++;
  ...
  exports.StringLiteral = StringLiteral = class StringLiteral extends Literal {
    ...
    withoutQuotesInLocationData() {
      ...
      locationData = merge({}, this.locationData);
    ...
    shouldGenerateTemplateLiteralAst() {
      return this.quote.length === 3; // and @originalValue.indexOf('\n') > -1
    }
    ...
    astFull(o) {
      ...
      if (!o.compiling && this.shouldGenerateTemplateLiteralAst()) {
...
// multiline need to be indented.
  ...
  exports.Catch = Catch = (function() {
    class Catch extends Base {
      ...
      makeReturn(res) {
        var ret;
        ret = this.recovery.makeReturn(res);
        if (!(res != null ? res.mark : void 0)) {
          this.recovery = ret;
        }
        return this;
      }
