      ...
      astProperties(o) {
        ...
        for (index = j = 0, len1 = elements.length; j < len1; index = ++j) {
          ...
          if (element instanceof StringLiteral) {
            ...
            quasis.push(o.compiling ? element.withAstLocationData(merge({
