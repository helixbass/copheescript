...
// multiline need to be indented.
  ...
  jisonLocationDataToAstLocationData = function({first_line, first_column, last_line, last_column, range, ends_line}) {
    return {
      loc: {
        start: {
          line: first_line + 1,
          ...
          line: ends_line ? last_line + 2 : last_line + 1,
          column: ends_line ? 0 : last_column + 1
        }
      },
