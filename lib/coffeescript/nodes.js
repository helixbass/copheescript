  ...
  exports.If = If = (function() {
    class If extends Base {
      ...
      statementToAst(o) {
        ...
        return {
          test: this.condition.toAst(o, LEVEL_PAREN),
      ...
      expressionToAst(o) {
        return {
          test: this.condition.toAst(o, LEVEL_COND),
          consequent: this.bodyNode().toAst(o, LEVEL_LIST),
          alternate: this.elseBodyNode() ? this.elseBodyNode().toAst(o, LEVEL_LIST) : new UndefinedLiteral().toAst(o)
        };
      }
