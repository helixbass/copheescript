...
(function() {
  ...
  var Access, Arr, Assign, AwaitReturn, Base, Block, BooleanLiteral, CSXTag, Call, Class, Code, CodeFragment, ComputedPropertyName, DefaultLiteral, Elision, ExecutableClassBody, Existence, Expansion, ExportAllDeclaration, ExportDeclaration, ExportDefaultDeclaration, ExportNamedDeclaration, ExportSpecifier, ExportSpecifierList, Extends, For, FuncGlyph, HereComment, HoistTarget, IdentifierLiteral, If, ImportClause, ImportDeclaration, ImportDefaultSpecifier, ImportNamespaceSpecifier, ImportSpecifier, ImportSpecifierList, In, Index, InfinityLiteral, JS_FORBIDDEN, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, LineComment, Literal, ModuleDeclaration, ModuleSpecifier, ModuleSpecifierList, NEGATE, NO, NaNLiteral, NullLiteral, NumberLiteral, Obj, Op, Param, Parens, PassthroughLiteral, PropertyName, Range, RegexLiteral, RegexWithInterpolations, Return, SIMPLENUM, Scope, Sequence, Slice, Splat, StatementLiteral, StringLiteral, StringWithInterpolations, Super, SuperCall, SuperLiteral, Switch, TAB, THIS, TaggedTemplateCall, ThisLiteral, Throw, Try, UTILITIES, UTILITIES_BABYLON, UndefinedLiteral, Value, While, YES, YieldReturn, addDataToNode, attachCommentsToNode, babylon, compact, del, dump, ends, extend, flatten, fragmentsToText, getNumberValue, hasLineComments, indentInitial, isArray, isBoolean, isLiteralArguments, isLiteralThis, isPlainObject, isUnassignable, locationDataToBabylon, locationDataToString, mapValues, merge, moveComments, multident, prettier, shouldCacheOrIsAssignable, some, starts, throwSyntaxError, unfoldSoak, unshiftAfterComments, utility, utilityBabylon,
    indexOf = [].indexOf,
    splice = [].splice,
    slice1 = [].slice,
    _extends1 = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
  ...
  ({compact, flatten, extend, merge, del, starts, ends, some, addDataToNode, attachCommentsToNode, locationDataToString, throwSyntaxError, getNumberValue, dump, locationDataToBabylon, isArray, isBoolean, isPlainObject, mapValues} = require('./helpers'));
  ...
  exports.Base = Base = (function() {
    class Base {
      ...
      withEmptyBabylonLocationData(compiled) {
        return this.withBabylonLocationData(compiled, {
          locationData: {
            first_line: 0,
            first_column: 0,
            last_line: 0,
      ...
      compileClosureToBabylon(o) {
        var func, wrapInAwait;
        o.sharedScope = true;
        func = new Code([], Block.wrap([this]));
        wrapInAwait = func.isAsync ? function(node) {
          return new Op('await', node);
        } : function(node) {
          return node;
        };
        return this.withLocationData(wrapInAwait(this.contains(isLiteralArguments) ? new Call(new Value(func, [new Access(new PropertyName('apply'))]), [new ThisLiteral, new IdentifierLiteral('arguments')]) : new Call(func, []))).compileToBabylon(o);
      }
      ...
      // call.
      hoist() {
        var _compileToBabylon, compileNode, compileToFragments, target;
        this.hoisted = true;
        ...
        _compileToBabylon = this._compileToBabylon;
        this._compileToBabylon = function(o) {
          return target.updateBabylon(_compileToBabylon, o);
        };
        return target;
      }
  ...
  exports.Block = Block = (function() {
    class Block extends Base {
      ...
      prettier(o) {
        ...
        return prettier.__debug.formatAST(ast, merge(opts, {
          originalText: code
        })).formatted;
      }
      ...
      compileToBabylon(o, level) {
        if (!o.scope) {
          return this.compileRootToBabylon(o);
        }
      ...
      compileRootToBabylon(o) {
        ...
        return this.withBabylonLocationData({
          ...
          program: {
            type: 'Program',
            sourceType: 'module',
            body: HoistTarget.expandBabylon(this.compileWithDeclarationsToBabylon(merge(o, {
              root: true
            }))),
      ...
      _compileToBabylon(o) {
        ...
        if (root && !o.bare) {
          ...
          return this.compileBodyToBabylon(merge(o, {
            expressions: [new Call(new Value(code, [new Access(new PropertyName('call'))]), [new ThisLiteral])],
            classScope: o.scope
          }));
        }
        ...
        return this.withBabylonLocationData({
          type: this.isClassBody ? 'ClassBody' : 'BlockStatement',
          body,
          directives: this.directives
        });
      }
      ...
      compileWithDeclarationsToBabylon(o) {
        return this._compileToBabylon(merge(o, {
          level: LEVEL_TOP,
      ...
      compileScopeDeclarationsToBabylon(o) {
        var declaredVariable, j, len1, ref1, results;
      ...
      asExpressionStatement(compiled) {
        if (compiled.type === 'VariableDeclaration') {
          return compiled;
        }
        return {
  ...
  exports.StringLiteral = StringLiteral = class StringLiteral extends Literal {
    ...
    isDirective() {
      return this.unquote() === 'use strict'; // TODO: refine
    }
    ...
    _compileToBabylon(o) {
      var compiled, isDirective;
      if (this.csx) {
        return this.compileCSXTextToBabylon(o);
      }
      isDirective = this.isDirective();
      compiled = {
        type: isDirective ? 'DirectiveLiteral' : 'StringLiteral',
        value: this.unquote(),
        extra: {
          raw: this.value
        }
  ...
  exports.PassthroughLiteral = PassthroughLiteral = class PassthroughLiteral extends Literal {
    _compileToBabylon(o) {
      ...
      return babylon.parse(this.value, {
        sourceType: 'module'
      }).program.body;
    }
  ...
  exports.IdentifierLiteral = IdentifierLiteral = (function() {
    class IdentifierLiteral extends Literal {
      ...
      _compileToBabylon(o) {
        return {
          type: this.csx ? 'JSXIdentifier' : 'Identifier',
          name: this.value
        };
      }
    ...
    class Return extends Base {
      ...
      _compileToBabylon(o) {
        ...
        return {
          ...
          argument: (ref1 = (ref2 = this.expression) != null ? ref2.compileToBabylon(o) : void 0) != null ? ref1 : null
        };
      }
...
// multiline need to be indented.
  ...
  exports.Value = Value = (function() {
    class Value extends Base {
      ...
      isDirective() {
        return this.isString() && this.base.isDirective();
      }
      ...
      _compileToBabylon(o) {
        var j, len1, prop, props, ret;
        props = this.properties;
        ret = this.base.compileToBabylon(o, props.length ? LEVEL_ACCESS : null);
        for (j = 0, len1 = props.length; j < len1; j++) {
          prop = props[j];
          ret = prop instanceof Slice ? prop.compileValueToBabylon(o, ret) : {
  ...
  exports.Call = Call = (function() {
    class Call extends Base {
      ...
      _compileToBabylon(o) {
        var arg;
        if (this.csx) {
          return this.compileCSXToBabylon(o);
        }
        return {
          type: this.isNew ? 'NewExpression' : 'CallExpression',
          callee: this.variable.compileToBabylon(o, LEVEL_ACCESS),
          arguments: (function() {
            ...
            for (j = 0, len1 = ref1.length; j < len1; j++) {
              arg = ref1[j];
              results.push(arg.compileToBabylon(o, LEVEL_LIST));
            }
            return results;
          }).call(this)
        };
      ...
      compileCSXToBabylon(o) {
        var attr, attributes, base1, compiled, content, tagName;
        [attributes, content] = this.args;
        tagName = this.variable.base;
        return _extends1({}, (!tagName.value.length ? {
          type: 'JSXFragment',
          ...
          children: content && !(typeof (base1 = content.base).isEmpty === "function" ? base1.isEmpty() : void 0) ? (content.base.csx = true, compact(flatten([content.compileToBabylon(o)]))) : [] //, LEVEL_LIST
        });
      }
  ...
  exports.Super = Super = (function() {
    class Super extends Base {
      ...
      _compileToBabylon(o) {
        this.setAccessor(o);
        return new Value(new SuperLiteral, this.accessor ? [this.accessor] : []).compileToBabylon(o);
      }
  ...
  exports.TaggedTemplateCall = TaggedTemplateCall = class TaggedTemplateCall extends Call {
    ...
    _compileToBabylon(o) {
      return {
        ...
        tag: this.variable.compileToBabylon(o, LEVEL_ACCESS),
        quasi: this.args[0].compileToBabylon(o, LEVEL_LIST)
      };
    }
  ...
  exports.Access = Access = (function() {
    class Access extends Base {
      ...
      _compileToBabylon(o) {
        return this.name.compileToBabylon(o);
      }
  ...
  exports.Index = Index = (function() {
    class Index extends Base {
      ...
      _compileToBabylon(o) {
        return this.index.compileToBabylon(o);
      }
  ...
  exports.Obj = Obj = (function() {
    class Obj extends Base {
      ...
      _compileToBabylon(o) {
        var compiledKey, compiledValue, isComputedPropertyName, prop, shorthand, value, variable;
        if (this.csx) {
          return this.compileCSXAttributesToBabylon(o);
        }
        this.propagateLhs();
        return {
          type: this.lhs ? 'ObjectPattern' : 'ObjectExpression',
          properties: (function() {
            var j, len1, ref1, results;
            ...
            for (j = 0, len1 = ref1.length; j < len1; j++) {
              ...
              compiledKey = (isComputedPropertyName ? variable.base.value : variable.unwrap()).compileToBabylon(o, LEVEL_LIST);
              compiledValue = value.compileToBabylon(o, LEVEL_LIST);
              results.push(prop.withBabylonLocationData({
                type: 'ObjectProperty',
                key: compiledKey,
                ...
                shorthand: !!shorthand,
                computed: isComputedPropertyName || variable.shouldCache()
              }));
            }
            return results;
          }).call(this)
        ...
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          ...
          results.push((() => {
            ...
            // `{ [expression] }` output as `{ [expression]: expression }`.
              ...
              context: 'object'
            }) : new Assign(prop, prop, {
              context: 'object',
              shorthand: typeof prop.bareLiteral === "function" ? prop.bareLiteral(IdentifierLiteral) : void 0
            }));
          })());
        }
        return results;
      ...
      propagateLhs() {
        ...
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          ...
          if (unwrappedVal instanceof Arr || unwrappedVal instanceof Obj) {
            results.push(unwrappedVal.lhs = true);
      ...
      compileCSXAttributesToBabylon(o) {
        ...
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          prop = ref1[j];
          prop.csx = true;
          results.push(prop.compileToBabylon(o)); //, LEVEL_TOP
        }
        return results;
      }
  ...
  exports.Arr = Arr = (function() {
    class Arr extends Base {
      ...
      _compileToBabylon(o) {
        var obj;
        return {
          type: this.lhs ? 'ArrayPattern' : 'ArrayExpression',
          elements: (function() {
            var j, len1, ref1, results;
            ref1 = this.objects;
            results = [];
            for (j = 0, len1 = ref1.length; j < len1; j++) {
              obj = ref1[j];
              results.push(obj.compileToBabylon(o, LEVEL_LIST));
            }
            return results;
          }).call(this)
        };
  ...
  exports.Class = Class = (function() {
    class Class extends Base {
      ...
      compileClassDeclarationToBabylon(o) {
        return {
          type: o.level === LEVEL_TOP ? 'ClassDeclaration' : 'ClassExpression',
          id: this.name ? new IdentifierLiteral(this.name).compileToBabylon(o) : void 0,
  ...
  exports.ExecutableClassBody = ExecutableClassBody = (function() {
    class ExecutableClassBody extends Base {
      ...
      _compileToBabylon(o) {
        var ident, ref1, wrapper;
        wrapper = new Code([], this.body);
        ...
        this.walkBody();
        this.setContext();
        this.body.expressions.unshift(this.name !== this.class.name ? new Assign(new IdentifierLiteral(this.name), this.class) : this.class);
        this.body.expressions.push(ident);
        return new Parens(new Call(new Value(wrapper, [new Access(new PropertyName('call'))]), [new ThisLiteral])).compileToBabylon(o);
      }
  ...
  exports.ImportDeclaration = ImportDeclaration = class ImportDeclaration extends ModuleDeclaration {
    _compileToBabylon(o) {
      ...
      return {
        ...
        specifiers: (ref1 = (ref2 = this.clause) != null ? ref2.compileToBabylon(o) : void 0) != null ? ref1 : [],
        source: this.source.compileToBabylon(o),
        importKind: this.clause ? 'value' : void 0
      };
    }
  ...
  exports.ImportClause = ImportClause = (function() {
    class ImportClause extends Base {
      ...
      _compileToBabylon(o) {
        var ref1, ref2;
        return compact(flatten([(ref1 = this.defaultBinding) != null ? ref1.compileToBabylon(o) : void 0, (ref2 = this.namedImports) != null ? ref2.compileToBabylon(o) : void 0]));
      }
  ...
  exports.ExportNamedDeclaration = ExportNamedDeclaration = class ExportNamedDeclaration extends ExportDeclaration {
    _compileToBabylon(o) {
      ...
      return _extends1({
        ...
        specifiers: this.clause.compileToBabylon(o)
      } : {
        specifiers: [],
        declaration: this.clause.compileToBabylon(o)
      }), {
        source: (ref1 = this.source) != null ? ref1.compileToBabylon(o) : void 0,
        exportKind: 'value'
      });
    }
  ...
  exports.ModuleSpecifierList = ModuleSpecifierList = (function() {
    class ModuleSpecifierList extends Base {
      ...
      _compileToBabylon(o) {
        ...
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          specifier = ref1[j];
          results.push(specifier.compileToBabylon(o));
        }
        return results;
      }
  ...
  exports.ImportSpecifier = ImportSpecifier = class ImportSpecifier extends ModuleSpecifier {
    ...
    _compileToBabylon(o) {
      ...
      compiledOriginal = this.original.compileToBabylon(o);
      return {
        type: 'ImportSpecifier',
        imported: compiledOriginal,
        local: (ref1 = (ref2 = this.alias) != null ? ref2.compileToBabylon(o) : void 0) != null ? ref1 : compiledOriginal
      };
    }
  ...
  exports.ImportDefaultSpecifier = ImportDefaultSpecifier = class ImportDefaultSpecifier extends ImportSpecifier {
    _compileToBabylon(o) {
      return {
        ...
        local: this.original.compileToBabylon(o)
      };
    }
  ...
  exports.ImportNamespaceSpecifier = ImportNamespaceSpecifier = class ImportNamespaceSpecifier extends ImportSpecifier {
    _compileToBabylon(o) {
      return {
        ...
        local: (() => {
          if (this.alias) {
            return this.alias.compileToBabylon(o);
          }
          return this.original.compileToBabylon(o);
        })()
      };
    }
  ...
  exports.ExportSpecifier = ExportSpecifier = class ExportSpecifier extends ModuleSpecifier {
    ...
    _compileToBabylon(o) {
      ...
      return {
        ...
        exported: (ref1 = (ref2 = this.alias) != null ? ref2.compileToBabylon(o) : void 0) != null ? ref1 : compiledOriginal
      };
    }
  ...
  exports.Assign = Assign = (function() {
    class Assign extends Base {
      ...
      _compileToBabylon(o) {
        var ref1, ref2;
        if (this.csx) {
          return this.compileCSXAttributeToBabylon(o);
        }
        ...
        return _extends1({}, (this.param || this.nestedLhs ? {
          type: 'AssignmentPattern'
        } : {
          type: 'AssignmentExpression',
          operator: this.context || '=' // TODO: using @context here is wrong?
        }), {
          left: this.variable.compileToBabylon(o, LEVEL_LIST),
          right: this.value.compileToBabylon(o, LEVEL_LIST)
        });
      }
      ...
      compileCSXAttributeToBabylon(o) {
        return {
          ...
          value: this.value.base instanceof StringLiteral ? this.value.base.compileToBabylon(o) : {
            type: 'JSXExpressionContainer',
            expression: this.value.base.compileToBabylon(o)
          }
        };
      }
      ...
      compileNode(o) {
        var answer, compiledName, hasSplat, isValue, name, objDestructAnswer, properties, prototype, ref1, ref2, ref3, ref4, ref5, val;
      ...
      compileObjectDestruct(o) {
        ...
        for (j = 0, len1 = restElements.length; j < len1; j++) {
          ...
          result.push(new Assign(new Value(restElement.name), value, {
      ...
      compileDestructuringToBabylon(o) {
        var assigns, cachedValueAssign, expans, expansIndex, getSlice, getSplice, i, isExpans, isSplat, leftObjs, obj, objects, processObjects, rightObjs, slicer, splats, splatsAndExpans, value;
        ({value} = this);
        ...
        processObjects = function(objs, rhs = value) {
          return assigns.push(new Assign(new Value(new Arr(objs, {
            lhs: true
          })), rhs));
        };
        ...
        return (new Sequence(assigns)).compileToBabylon(o, LEVEL_LIST);
      }

      // Brief implementation of recursive pattern matching, when assigning array or
      // object literals to a value. Peeks at their properties to assign inner names.
      compileDestructuring(o) {
        var assignObjects, assigns, code, compSlice, compSplice, complexObjects, expIdx, expans, fragments, hasObjAssigns, hasObjSpreads, i, isExpans, isObject, isSplat, leftObjs, loopObjects, obj, objIsUnassignable, objects, olen, processObjects, ref, refExp, restVar, rightObjs, slicer, splats, splatsAndExpans, top, value, vvar, vvarText;
        top = o.level === LEVEL_TOP;
        ({value} = this);
        ({objects} = this.variable.base);
        olen = objects.length;
        ...
        loopObjects = (objs, vvar, vvarTxt) => {
          ...
          for (i = j = 0, len1 = objs.length; j < len1; i = ++j) {
            ...
            results.push(assigns.push(new Assign(vvar, vval, {
              param: this.param,
              subpattern: true
        ...
        assignObjects = (objs, vvar, vvarTxt) => {
          ...
          return assigns.push(new Assign(vvar, vval, {
            param: this.param,
            subpattern: true
          }).compileToFragments(o, LEVEL_LIST));
        };
  ...
  exports.Code = Code = (function() {
    class Code extends Base {
      ...
      compileParamsToBabylon({params, haveSplatParam, o}) {
        var index, j, lastIndex, len1, param, results;
        lastIndex = params.length - 1;
        results = [];
        for (index = j = 0, len1 = params.length; j < len1; index = ++j) {
          param = params[index];
          if (haveSplatParam && index === lastIndex) {
            results.push(param.withBabylonLocationData({
              type: 'RestElement',
              argument: param.compileToBabylon(o)
            }));
          } else {
            results.push(param.compileToBabylon(o));
          }
        }
        return results;
      }
      ...
      processParams(o) {
        var exprs, haveSplatParam, name, param, params, paramsAfterSplat, splat, splatParamName, value;
        exprs = [];
        ...
        params = compact((function() {
          ...
          for (j = 0, len1 = ref1.length; j < len1; j++) {
            ...
            if (splat || param instanceof Expansion) {
              ...
              results.push(splatParamName);
            } else if (!haveSplatParam) {
              if (name instanceof Arr || name instanceof Obj) {
                // This parameter is destructured.
                name.lhs = true;
                if (!param.shouldCache()) {
                  name.eachName(function({value}) {
              ...
              if (value) {
                results.push(new Assign(new Value(name), value, {
                  param: true
                }));
              } else {
                results.push(param);
              ...
              if ((name != null ? name.value : void 0) != null) {
                o.scope.add(name.value, 'var', true);
              }
              results.push(null);
            }
          }
      ...
      _compileToBabylon(o) {
        var exprs, haveSplatParam, params, thisAssignments, wasEmpty;
      ...
      addtlMethodBabylonFields(o) {
        ...
        return {
          ...
          key: this.name.compileToBabylon(o),
          computed: this.name instanceof Access && this.name.name instanceof ComputedPropertyName
        };
      }
        ...
        this.eachParamName((name, node, param, obj) => {
          ...
          if (node.this) {
            ...
            if (param.name instanceof Obj && obj instanceof Assign && obj.operatorToken.value === '=') {
              replacement = param.withLocationData(new Assign(new IdentifierLiteral(name), new Assign(target, obj.value), {
            ...
            if (!haveSplatParam) {
              ...
              if (param.name instanceof Arr || param.name instanceof Obj) {
                ...
                if (param.name instanceof Obj && param.name.hasSplat()) {
                  ...
                  // Compile `foo({a, b...} = {}) ->` to `foo(arg = {}) -> {a, b...} = arg`.
                  if ((param.value != null) && !param.assignedInBody) {
                    ref = new Assign(ref, param.value, {
                      param: true
                    });
                  }
  ...
  exports.Param = Param = (function() {
    class Param extends Base {
      ...
      compileToBabylon(o) {
        return this.name.compileToBabylon(o, LEVEL_LIST);
      }
        ...
        replacement = (node, parent) => {
          ...
          if (parent instanceof Obj && expandAssign) {
            ...
            if (node.this && key.value === newNode.value) {
              ...
              return new Assign(new Value(key), newNode, {
                context: 'object'
              });
            }
          } else {
  ...
  exports.Splat = Splat = (function() {
    class Splat extends Base {
      ...
      _compileToBabylon(o) {
        return {
          type: this.csx ? 'JSXSpreadAttribute' : 'SpreadElement',
          argument: this.name.compileToBabylon(o, LEVEL_OP)
        };
      }
  ...
  exports.While = While = (function() {
    class While extends Base {
      constructor(condition, {invert, guard} = {}) {
        super();
        this.guard = guard;
        this.condition = invert ? condition.invert() : condition;
      }
      ...
      _compileToBabylon(o) {
        ...
        return this.wrapInResultAccumulatingBlock({o, resultsVar})({
          type: 'WhileStatement',
          test: this.condition.compileToBabylon(o, LEVEL_PAREN),
  ...
  exports.Op = Op = (function() {
    ...
    class Op extends Base {
      ...
      _compileToBabylon(o) {
        ...
        if (this.isUnary()) {
          return this.compileUnaryToBabylon(o);
        }
        if (isChain) {
        ...
        switch (this.operator) {
          ...
          case '**':
            return this.compilePowerToBabylon(o);
          case '//':
        ...
        if (o.level > LEVEL_OP) {
          return new Parens(this).compileToBabylon(o);
        }
        return this.compileBinaryToBabylon(o);
      }
      ...
      compileUnaryToBabylon(o) {
        if (this.operator === 'new') {
          return {
            type: 'NewExpression',
            callee: this.first.compileToBabylon(o),
            arguments: []
          };
        }
        ...
        return {
          ...
          prefix: !this.flip,
          argument: this.first.compileToBabylon(o)
        };
      }
      ...
      compileBinaryToBabylon(o) {
        return {
          ...
          left: this.first.compileToBabylon(o, LEVEL_OP),
          operator: this.operator,
          right: this.second.compileToBabylon(o, LEVEL_OP)
        };
      }
      ...
      compileExistenceToBabylon(o, checkOnlyUndefined) {
        ...
        return this.withLocationData(new If(new Existence(cachedFirstAssign, checkOnlyUndefined), first, {
          type: 'if'
      ...
      powerCall() {
        ...
        return new Call(pow, [this.first, this.second]);
      }

      compilePower(o) {
        return this.powerCall().compileToFragments(o);
      }

      compilePowerToBabylon(o) {
        return this.powerCall().compileToBabylon(o);
      }
  ...
  exports.In = In = (function() {
    class In extends Base {
      ...
      compileLoopTestToBabylon(o) {
        ...
        indexOfCheck = new Op((this.negated ? '<' : '>='), utilityBabylon('indexOf', merge(o, {
  ...
  exports.Try = Try = (function() {
    class Try extends Base {
      ...
      _compileToBabylon(o) {
        ...
        return {
          type: 'TryStatement',
          block: this.attempt.compileToBabylon(o, LEVEL_TOP),
          handler: placeholder ? {
            type: 'CatchClause',
            param: placeholder.compileToBabylon(o),
            body: (this.recovery || this.withLocationData(new Block)).compileToBabylon(o, LEVEL_TOP)
          } : void 0,
          finalizer: (ref1 = this.ensure) != null ? ref1.compileToBabylon(o, LEVEL_TOP) : void 0
        };
      }
  ...
  exports.Throw = Throw = (function() {
    class Throw extends Base {
      ...
      _compileToBabylon(o) {
        return {
          type: 'ThrowStatement',
          argument: this.expression.compileToBabylon(o, LEVEL_LIST)
        };
      }
    ...
    class Existence extends Base {
      ...
      _compileToBabylon(o) {
        ...
        comparison = this.expression.unwrap() instanceof IdentifierLiteral && !o.scope.check(this.expression.unwrap().value) ? (() => {
          var comparisonAgainstUndefined;
          comparisonAgainstUndefined = this.withLocationData(new Op(compareOp, new Op('typeof', this.expression), new StringLiteral("'undefined'")));
  ...
  exports.Parens = Parens = (function() {
    class Parens extends Base {
      ...
      _compileToBabylon(o) {
        ...
        return _extends1({}, compiled, {
          extra: _extends1({}, (ref1 = compiled.extra) != null ? ref1 : {}, {
            parenthesized: true
          })
        });
      }
  ...
  exports.StringWithInterpolations = StringWithInterpolations = (function() {
    class StringWithInterpolations extends Base {
      constructor(body1, {startQuote, endQuote} = {}) {
        super();
        this.body = body1;
      ...
      _compileToBabylon(o) {
        ...
        if (this.csx) {
          return this.compileCSXContentToBabylon(o);
        }
      ...
      compileCSXContentToBabylon(o) {
        var compiled, element, elements, hasComment, j, len1, results;
        elements = this.extractElements();
        results = [];
        for (j = 0, len1 = elements.length; j < len1; j++) {
          ...
          hasComment = (function() {
            hasComment = false;
            element.traverseChildren(false, function({comments}) {
              if (comments) {
                hasComment = true;
                return false;
              }
          ...
          } else if (compiled.type === 'JSXElement' && !hasComment) {
            results.push(compiled);
          } else {
  ...
  exports.For = For = (function() {
    class For extends While {
      constructor(body, source) {
        var ref1, ref2;
        super();
        ({source: this.source, guard: this.guard, step: this.step, name: this.name, index: this.index, accumulateIndex: this.accumulateIndex} = source);
      ...
      hoistComments() {
        ...
        for (j = 0, len1 = ref1.length; j < len1; j++) {
          ...
          results.push(moveComments(this[attribute], this));
        }
        return results;
      }
      ...
      compileObjectToBabylon({o, sourceVar, keyVar, resultsVar, cachedSourceVarAssign}) {
        if (this.own) {
          this.body.expressions.unshift(new If(new Op('!', utilityBabylon('hasProp', merge(o, {
      ...
      _compileToBabylon(o) {
        ...
        return this.wrapInResultAccumulatingBlock({o, resultsVar, cachedSourceVarAssign, cachedStepVarAssign})(_extends1({
          type: 'ForStatement'
        }, (this.range ? this.source.base.compileToBabylon(merge(o, {
          indexVar,
          keyVar,
          step: this.step,
          shouldCache: shouldCacheOrIsAssignable
      ...
      // some cannot.
      compileNode(o) {
        var body, bodyFragments, compare, compareDown, declare, declareDown, defPart, down, forPartFragments, fragments, guardPart, idt1, increment, index, ivar, kvar, kvarAssign, lvar, name, namePart, ref, resultPart, returnResult, rvar, scope, source, step, stepNum, stepVar, svar, varPart;
        this.updateReturnsBasedOnLastBodyExpression();
        body = this.body;
      ...
      _compileToBabylon(o) {
        ...
        return {
          ...
          expressions: (function() {
            ...
            for (j = 0, len1 = ref1.length; j < len1; j++) {
              expression = ref1[j];
              results.push(expression.compileToBabylon(o));
            }
            return results;
          }).call(this)
        };
  ...
  exports.Switch = Switch = (function() {
    class Switch extends Base {
      ...
      _compileToBabylon(o) {
        var caseIndex, consequent, kase, lastCaseIndex, lastTestIndex, ref1, ref2, test, testIndex, tests;
        lastCaseIndex = this.cases.length - 1;
        return {
          type: 'SwitchStatement',
          discriminant: ((ref1 = this.subject) != null ? ref1 : new BooleanLiteral('false')).compileToBabylon(o, LEVEL_PAREN),
          cases: [
            ...flatten((function() {
              var j,
            len1,
            ...
            results;
              ref2 = this.cases;
              results = [];
              for (caseIndex = j = 0, len1 = ref2.length; j < len1; caseIndex = ++j) {
                kase = ref2[caseIndex];
                [tests,
            consequent] = kase;
                tests = flatten([tests]);
            ...
            results1;
                  ...
                  for (testIndex = k = 0, len2 = tests.length; k < len2; testIndex = ++k) {
                    ...
                    results1.push(test.withBabylonLocationData((() => {
                      ...
                      return {
                        type: 'SwitchCase',
                        test: (this.subject ? test : test.invert()).compileToBabylon(o,
            LEVEL_PAREN),
                        consequent: testIndex === lastTestIndex ? consequent.compileToBabylon(o,
            LEVEL_TOP).body : []
                      };
                    })()));
                  }
            ...
            ...(((ref2 = this.otherwise) != null ? ref2.expressions.length : void 0) ? [
              {
                type: 'SwitchCase',
                test: null,
                consequent: this.otherwise.compileToBabylon(o,
              LEVEL_TOP).body
              }
            ] : [])
          ]
  ...
  exports.If = If = (function() {
    class If extends Base {
      ...
      _compileToBabylon(o) {
        if (this.isStatement(o)) {
          return this.compileStatementToBabylon(o);
        } else {
          return this.compileExpressionToBabylon(o);
        }
      }
      ...
      compileStatementToBabylon(o) {
        ...
        return {
          type: 'IfStatement',
          test: this.condition.compileToBabylon(o, LEVEL_PAREN),
          consequent: this.ensureBlock(this.body).compileToBabylon(o),
          alternate: this.elseBody ? this.elseBody.compileToBabylon(o, LEVEL_TOP) : void 0
        };
      }
      ...
      compileExpressionToBabylon(o) {
        return {
          ...
          test: this.condition.compileToBabylon(o, LEVEL_COND),
          consequent: this.bodyNode().compileToBabylon(o, LEVEL_LIST),
          alternate: this.elseBodyNode() ? this.elseBodyNode().compileToBabylon(o, LEVEL_LIST) : new UndefinedLiteral().compileToBabylon(o)
        };
      }
  ...
  utilityBabylon = function(name, o) {
    var appliedWithArgs, calledWithArgs, ref, root;
    calledWithArgs = del(o, 'calledWithArgs');
    appliedWithArgs = del(o, 'appliedWithArgs');
    ({root} = o.scope);
    ref = new IdentifierLiteral(name in root.utilities ? root.utilities[name] : (ref = root.freeVariable(name), root.assign(ref, UTILITIES_BABYLON[name](o)), root.utilities[name] = ref));
    if (!(calledWithArgs || appliedWithArgs)) {
      return ref;
    }
    return new Call(new Value(ref, [new Access(new PropertyName(calledWithArgs ? 'call' : 'apply'))]), calledWithArgs != null ? calledWithArgs : appliedWithArgs);
  };
