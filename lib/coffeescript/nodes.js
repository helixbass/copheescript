...
// compact(
      ...
      ast(o, level) {
        ...
        if (this.isStatement(o) && o.level !== LEVEL_TOP) {
          this.makeReturn({
            mark: true
          });
        }
        ...
        ast = Object.assign({}, this.astProperties(o), {
          type: this.astType(o)
  ...
  exports.Block = Block = (function() {
    class Block extends Base {
      ...
      ast(o, level) {
        ...
        if (level !== LEVEL_TOP && this.expressions.length) {
...
// multiline need to be indented.
  ...
  exports.YieldReturn = YieldReturn = class YieldReturn extends Return {
    ...
    ast(o, level) {
      ...
      return new Op('yield', new Return(this.expression)).withLocationDataFrom(this).ast(o, level);
    }
  ...
  exports.AwaitReturn = AwaitReturn = class AwaitReturn extends Return {
    ...
    ast(o, level) {
      ...
      return new Op('await', new Return(this.expression)).withLocationDataFrom(this).ast(o, level);
    }
