...
// TODO: directives
    ...
    for (index = j = 0, len = body.length; j < len; index = ++j) {
      ...
      results.push(this.print(stmt, merge(o, {
        spaced: false,
        asStatement: true,
        level: LEVEL_TOP
      })));
  ...
  BLOCK = ['IfStatement', 'ForStatement', 'ForInStatement', 'ForOfStatement', 'WhileStatement', 'ClassDeclaration', 'TryStatement', 'SwitchStatement', 'ClassMethod'];
  ...
  printObject = function(o) {
    var index, isCompact, j, k, len, len1, prop, ref, ref1, shorthand;
    isCompact = true;
    ref = this.properties;
  ...
  printArray = function(o) {
    var closingNewline, element, elements, index, j, len, separator, shouldBreak;
  ...
  printBlock = function(o) {
    ...
    this.push('{');
    this.push('\n');
    this.printStatementSequence(this.body, indent(o));
    return this.push(o.indent + '}');
  };

  printSplat = function(o) {
    this.push('...');
    return this.print(this.argument);
  };
  ...
  printer = {
    ...
    MemberExpression: function(o) {
      var property;
      this.print(this.object, o, LEVEL_ACCESS);
