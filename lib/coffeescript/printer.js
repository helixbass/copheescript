...
(function() {
  var BLOCK, CodeFragment, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, PRECEDENCE, PRECEDENCE_LEVELS, SIMPLENUM, TAB, _dump, asStatement, compact, del, dump, extend, flatten, fragmentize, fragmentsToText, fronts, getPrecedence, i, indent, isArray, isClass, isString, j, k, leadsWithObject, len, len1, makeCode, merge, needsParens, nodeFragmentsToText, nodePrint, nodePrinted, op, print, printArray, printAssignment, printBinaryExpression, printBlock, printCall, printClass, printFunction, printObject, printParams, printSplat, printStatementSequence, printer, push, tier, unshift, wrapInBraces,
    indexOf = [].indexOf;
