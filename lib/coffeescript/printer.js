...
(function() {
  ...
  printer = {
    ...
    VariableDeclaration: function(o) {
      var declaration, fragments, indented, index, j, leadingSpace, len, ref;
      fragments = ['var '];
      ...
      for (index = j = 0, len = ref.length; j < len; index = ++j) {
        ...
        if (index) {
          fragments.push(',' + leadingSpace);
        }
        fragments.push(...this.print(declaration, indented != null ? indented : o));
      }
      return fragments;
    },
    ...
    TryStatement: function(o) {
      ...
      if (this.finalizer) {
        fragments.push(' finally ', ...this.print(this.finalizer, o));
      }
      return fragments;
    },
