  ...
  replDefaults = function(opts) {
    return {
      ...
      eval: function(input, context, filename, cb) {
        var Assign, Block, Call, Code, IdentifierLiteral, Value, ast, err, isAsync, js, ref, ref1, referencedVars, result, token, tokens;
        // XXX: multiline hack.
        ...
        try {
          ...
          ast = ast.withLocationData(new Block([
            new Assign(new Value(new IdentifierLiteral('__')),
            ast,
            {
              context: '='
            })
