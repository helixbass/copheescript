...
test 'import empty object', ->
  eqJS "import { } from 'lib'", "import {} from 'lib';"
...
test 'export default string', ->
  eqJS "export default 'foo'", "export default 'foo';"

test 'export default number', ->
  eqJS 'export default 5', 'export default 5;'
...
test 'export assignment expression', ->
  eqJS "export foo = 'bar'", "export var foo = 'bar';"
...
test 'export default function', ->
  eqJS 'export default ->', 'export default function() {};'
...
test "export an entire module's contents", ->
  eqJS "export * from 'lib'", "export * from 'lib';"
...
test 'export list can contain CoffeeScript keywords when aliasing', ->
  eqJS(
    "export { when as bar, baz as unless, and as foo, booze as not } from 'lib'",
    '''
    export {
      when as bar,
      baz as unless,
